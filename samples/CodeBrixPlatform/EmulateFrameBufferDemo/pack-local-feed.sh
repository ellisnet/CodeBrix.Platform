...
#
# Version 1.0.204.9999 is deliberately outside the real date-stamped scheme
# (minute-of-day never reaches 9999): it marks a local development pack, sorts
# above anything published on 2026-07-23, and can never collide with a real
...
LOCAL_VERSION="${LOCAL_VERSION:-1.0.204.9999}"
