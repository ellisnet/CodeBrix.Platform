...
src/Platform.CrossTargetting.targets. Update both locations together when introducing a new
...
#       src/Platform.CrossTargetting.targets (see the ItemGroup near the top of that file). When
