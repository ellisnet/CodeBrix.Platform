...
1.0.196.385 below:
    ...
    dotnet pack src/Platform.UI.Runtime.Skia.MacOS/Platform.UI.Runtime.Skia.MacOS.csproj \
      -c Release \
      -p:PackageVersion=1.0.196.385 \
      --output nugets/Release/1.0.196.385
...
still flowing to the ProjectReference dependency versions. This produces:
    ...
    nugets/Release/1.0.196.385/CodeBrix.Platform.Runtime.Skia.MacOS.ApacheLicenseForever.1.0.196.385.nupkg
