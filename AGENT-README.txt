...
1.0.184.252 below:
    ...
    dotnet pack src/Platform.UI.Runtime.Skia.MacOS/Platform.UI.Runtime.Skia.MacOS.csproj \
      -c Release \
      -p:PackageVersion=1.0.184.252 \
      --output nugets/Release/1.0.184.252
...
still flowing to the ProjectReference dependency versions. This produces:
    ...
    nugets/Release/1.0.184.252/CodeBrix.Platform.Runtime.Skia.MacOS.ApacheLicenseForever.1.0.184.252.nupkg
