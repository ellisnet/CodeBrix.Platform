...
// https://raw.githubusercontent.com/CommunityToolkit/dotnet/7b53ae23dfc6a7fb12d0fc058b89b6e948f48448/src/CommunityToolkit.Mvvm.SourceGenerators/Helpers/EquatableArray%7BT%7D.cs
// See https://andrewlock.net/creating-a-source-generator-part-9-avoiding-performance-pitfalls-in-incremental-generators/#4-watch-out-for-collection-types
...
public static class EquatableArray
{
    ...
    /// <param name="array">The input <see cref="ImmutableArray{T}"/> instance.</param>
    /// <returns>An <see cref="EquatableArray{T}"/> instance from a given <see cref="ImmutableArray{T}"/>.</returns>
    public static EquatableArray<T> ToEquatableArray<T>(this IEnumerable<T> en)
        where T : IEquatable<T>
    {
        return new(ImmutableArray<T>.Empty.AddRange(en));
    }
}
    ...
    where T : IEquatable<T>
{
    ...
    public override int GetHashCode()
    {
        ...
        var hashCode = array.Length.GetHashCode();
