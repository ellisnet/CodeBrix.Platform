...
using static CodeBrix.Platform.UI.Tests.Helpers.MuxVerify;
using static CodeBrix.Platform.UI.Xaml.Input.XYFocusAlgorithmHelper;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.Input.Internal //Was previously: Uno.UI.Tests.Windows_UI_Xaml.Input.Internal
{
	[TestClass]
