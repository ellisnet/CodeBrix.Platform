...
using CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.EventsTests.Controls;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.EventsTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml.EventsTests
{
	[TestClass]
