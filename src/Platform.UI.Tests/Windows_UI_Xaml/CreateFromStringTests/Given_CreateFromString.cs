...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.CreateFromStringTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml.CreateFromStringTests
{
	[TestClass]
	...
	[Windows.Foundation.Metadata.CreateFromString(MethodName = "CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.CreateFromStringTests.Location.ConvertToLatLong")]
