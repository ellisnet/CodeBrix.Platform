...
using CodeBrix.Platform.UI.Tests.ViewLibrary;
...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml //Was previously: Uno.UI.Tests.Windows_UI_Xaml
{
	...
	public class Given_ResourceDictionary
	{
		...
		public void When_Simple_Add_And_Retrieve_Type_Key()
		{
			...
			Assert.IsFalse(rd.ContainsKey("CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.Given_ResourceDictionary"));
		...
		{
			var rd = new ResourceDictionary { Source = new Uri("ms-appx:///CodeBrix.Platform.UI.Tests.ViewLibrary/Themes/More/Test_Dictionary_Abs.xaml") };
			AssertEx.AssertContainsColorBrushResource(rd, "BituminousColorBrush", Colors.SlateGray);

			var rd2 = new ResourceDictionary { Source = new Uri("ms-appx:///CodeBrix.Platform.UI.Tests.ViewLibrary/Themes/More/Test_Dictionary_Abs.xaml") };
		...
		public void When_SharedHelpers_FindResource()
		{
			...
			var brush = global::CodeBrix.Platform.UI.Helpers.WinUI.SharedHelpers.FindResource("Grin", rd, null);
