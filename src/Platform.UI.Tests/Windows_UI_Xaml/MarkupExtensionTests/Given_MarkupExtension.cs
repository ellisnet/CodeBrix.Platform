...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.MarkupExtensionTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml.MarkupExtensionTests
{
	[TestClass]
...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.MarkupExtensionTests.Nested //Was previously: Uno.UI.Tests.Windows_UI_Xaml.MarkupExtensionTests.Nested
{
