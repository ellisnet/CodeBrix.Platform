...
using static CodeBrix.Platform.UI.Tests.Windows_UI_Input.GestureRecognizerTestExtensions;

using SilverAssertions.Execution;
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Input //Was previously: Uno.UI.Tests.Windows_UI_Input
{
	[TestClass]
