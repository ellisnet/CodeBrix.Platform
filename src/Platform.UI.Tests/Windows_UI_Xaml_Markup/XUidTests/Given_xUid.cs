...
using CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XUidTests.Controls;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XUidTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Markup.XUidTests
{
	[TestClass]
