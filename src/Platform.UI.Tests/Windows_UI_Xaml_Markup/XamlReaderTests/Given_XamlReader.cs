...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests
{
	...
	public class Given_XamlReader : Context
	{
		...
		{
			Assert.ThrowsExactly<CodeBrix.Platform.Xaml.XamlParseException>(() =>
			{
		...
		{
			var xaml = "<NonDefaultXamlNamespace Test=\"42\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
		...
		{
			var xaml = "<CreateFromStringInvalidMethodNameOwner Test=\"8\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			Assert.ThrowsExactly<CodeBrix.Platform.Xaml.XamlParseException>(() => Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml));
		}

		[TestMethod]
		public void When_CreateFromString_Non_Qualified_MethodName()
		{
			var xaml = "<CreateFromStringNonQualifiedMethodNameOwner Test=\"16\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			var builder = Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml);
			if (builder is CreateFromStringFullyQualifiedMethodNameOwner owner)
			{
		...
		{
			var xaml = "<CreateFromStringNonStaticMethodOwner Test=\"4\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			Assert.ThrowsExactly<CodeBrix.Platform.Xaml.XamlParseException>(() => Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml));
		}
		...
		{
			var xaml = "<CreateFromStringPrivateStaticMethodOwner Test=\"21\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			Assert.ThrowsExactly<CodeBrix.Platform.Xaml.XamlParseException>(() => Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml));
		}
		...
		{
			var xaml = "<CreateFromStringInternalStaticMethodOwner Test=\"42\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			var builder = Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml);
			if (builder is CreateFromStringFullyQualifiedMethodNameOwner owner)
			{
		...
		{
			var xaml = "<CreateFromStringInvalidParametersOwner Test=\"2\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			Assert.ThrowsExactly<CodeBrix.Platform.Xaml.XamlParseException>(() => Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml));
		}
		...
		{
			var xaml = "<CreateFromStringInvalidReturnTypeOwner Test=\"1\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
		...
		{
			var xaml = "<CreateFromStringFullyQualifiedMethodNameOwner Test=\"12\" xmlns=\"using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests\" />";
			var builder = Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml);
			if (builder is CreateFromStringFullyQualifiedMethodNameOwner owner)
			{
		...
		public void When_Geometry()
		{
			...
			var geometry = Microsoft.UI.Xaml.Markup.XamlReader.Load(path) as CodeBrix.Platform.Media.StreamGeometry;
		...
		public void When_Vector3_Property()
		{
			var xaml =
				"""
				<VectorPropertyControl xmlns='CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests' Vec3="1,4,100" />
				""";
		...
		public void When_Vector2_Property()
		{
			var xaml =
				"""
				<VectorPropertyControl xmlns='CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests' Vec2="31,4" />
				""";
			var control = Microsoft.UI.Xaml.Markup.XamlReader.Load(xaml) as VectorPropertyControl;
		...
		public void When_CustomMarkupExtension_Simple()
		{
			var xaml =
				"""
				<Grid xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:local='using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests' Tag="{local:CustomMarkupExtension Value1=Hello, Value2=World}" />
				""";
		...
		public void When_CustomMarkupExtension_Responsive()
		{
			var xaml =
				"""
				<Grid xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:local='using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests' Grid.RowSpan="{local:ResponsiveExtension Narrow=1, Wide=2}" />
				""";
		...
		public void When_CustomMarkupExtension_ShortName()
		{
			var xaml =
				"""
				<Grid xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:local='using:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests' Tag="{local:CustomMarkup Value1=A, Value2=B}" />
				""";
