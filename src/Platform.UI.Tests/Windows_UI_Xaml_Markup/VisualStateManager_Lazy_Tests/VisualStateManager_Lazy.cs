...
using CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.VisualStateManager_Lazy_Tests.Controls;
using Windows.UI;
...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.VisualStateManager_Lazy_Tests //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Markup.VisualStateManager_Lazy_Tests
{
	[TestClass]
