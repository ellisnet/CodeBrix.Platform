...
using CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.MarkupExtensionTests.Controls;
using Microsoft.UI.Xaml;
using Microsoft.UI.Xaml.Controls;
using Microsoft.UI.Xaml.Markup;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Markup.MarkupExtensionTests; //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Markup.MarkupExtensionTests
