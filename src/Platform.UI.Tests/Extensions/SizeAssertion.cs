...
namespace CodeBrix.Platform.UI.Tests //Was previously: Uno.UI
{
	...
	internal class RectAssertion : ReferenceTypeAssertions<Rect, RectAssertion>
	{
		...
		{
			using (new AssertionScope(AssertionScope.Current?.Context?.Value + _rect.ToString()))
			{
