...
namespace UnitTestsApp
{
	...
	sealed partial class App : Application
	{
		...
		public static App EnsureApplication()
		{
			...
			{
				// Hot reload callbacks are generated from the XAML because CodeBrixForceHotReloadCodeGen is enabled, but here we disable
...
#if !NETFX_CORE
			//Clear custom theme
			CodeBrix.Platform.UI.ApplicationHelper.RequestedCustomTheme = null;
#endif
