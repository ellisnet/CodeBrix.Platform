...
namespace CodeBrix.Platform.UI.Tests.Foundation //Was previously: Uno.UI.Tests.Foundation
{
	[TestClass]
	public class Given_Rect
	{
		[TestInitialize]
		public void Init() => CodeBrix.Platform.FoundationFeatureConfiguration.Rect.AllowNegativeWidthHeight = false;

		[TestCleanup]
		public void Cleanup() => CodeBrix.Platform.FoundationFeatureConfiguration.Rect.RestoreDefaults();

		[TestMethod]
		public void When_Create_WithNegativeWidth_With_FeatureFlagEnabled()
		{
			CodeBrix.Platform.FoundationFeatureConfiguration.Rect.AllowNegativeWidthHeight = true;
