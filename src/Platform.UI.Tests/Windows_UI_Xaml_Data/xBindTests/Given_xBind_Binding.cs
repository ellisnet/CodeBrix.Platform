...
using CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.xBindTests.Controls;
using Windows.Foundation.Collections;
using Microsoft.UI.Xaml;
using Microsoft.UI.Xaml.Controls;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.xBindTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Data.xBindTests
{
	[TestClass]
	public class Given_xBind_Binding
	{
		...
		public void When_Converter()
		{
			...
			Assert.AreEqual("v:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.xBindTests.Controls.Binding_Converter p:test", SUT.myTextBlock2.Text);
		}
		...
		public void When_Converter_DataTemplate()
		{
			...
			Assert.AreEqual("v:CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.xBindTests.Controls.Binding_Converter_DataTempate_Model p:test", myTextBlock2.Text);
		}
		...
		public void When_PathLessCasting()
		{
			...
			SUT.ForceLoaded();
			const string CastResult = "ExplicitConversion_CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.xBindTests.Controls.xBind_PathLessCasting";
