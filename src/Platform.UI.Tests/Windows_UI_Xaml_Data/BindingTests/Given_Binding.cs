...
using CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.BindingTests.Controls;
using Microsoft.UI.Xaml.Controls;
using Microsoft.UI.Xaml.Data;
using SilverAssertions.Execution;
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Data.BindingTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Data.BindingTests
{
	[TestClass]
