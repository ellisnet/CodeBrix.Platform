...
using CodeBrix.Platform.UI.Tests.HotReload.Windows_UI_Xaml.Controls;
using Windows.Foundation;

namespace CodeBrix.Platform.UI.Tests.HotReload.Windows_UI_Xaml //Was previously: Uno.UI.Tests.HotReload.Windows_UI_Xaml
{
	[TestClass]
