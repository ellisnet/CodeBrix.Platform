...
using CodeBrix.Platform.UI.Tests.ResourceLoader.Controls;
using Windows.Globalization;
using _ResourceLoader = Windows.ApplicationModel.Resources.ResourceLoader;

namespace CodeBrix.Platform.UI.Tests.ResourceLoaderTests //Was previously: Uno.UI.Tests.ResourceLoaderTests
{
	[TestClass]
	public class Given_ResourceLoader
	{
		private const string DefaultLanguage = "en-US";
		private const string UITestResources = "CodeBrix.Platform.UI.Tests/Resources";
