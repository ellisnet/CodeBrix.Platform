...
using CodeBrix.Platform.UI.Tests.BinderTests;
using Microsoft.UI.Xaml;
using Microsoft.UI.Xaml.Input;
using Windows.ApplicationModel.VoiceCommands;

namespace CodeBrix.Platform.UI.Tests.DependencyPropertyTests //Was previously: Uno.UI.Tests.DependencyPropertyTests
{
	[TestClass]
