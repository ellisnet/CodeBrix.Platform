...
using CodeBrix.Platform.UI.Tests.Windows_UI_XAML_Controls.RadioButtonsTests.Controls;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_XAML_Controls.RadioButtonsTests //Was previously: Uno.UI.Tests.Windows_UI_XAML_Controls.RadioButtonsTests
{
	[TestClass]
