...
using CodeBrix.Platform.UI.Tests.Windows_UI_XAML_Controls.GridTests.Controls;

using SilverAssertions.Execution;
namespace CodeBrix.Platform.UI.Tests.GridTests //Was previously: Uno.UI.Tests.GridTests
{
	[TestClass]
