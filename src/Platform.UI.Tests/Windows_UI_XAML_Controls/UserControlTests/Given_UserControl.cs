...
using CodeBrix.Platform.UI.Tests.Windows_UI_XAML_Controls.UserControlTests;
using Microsoft.UI.Xaml;
using Microsoft.UI.Xaml.Controls;
using Microsoft.UI.Xaml.Data;

namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml_Controls.xLoad //Was previously: Uno.UI.Tests.Windows_UI_Xaml_Controls.xLoad
{
	[TestClass]
