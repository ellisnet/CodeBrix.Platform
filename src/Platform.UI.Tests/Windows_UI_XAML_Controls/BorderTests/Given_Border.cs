...
namespace CodeBrix.Platform.UI.Tests.BorderTests //Was previously: Uno.UI.Tests.BorderTests
{
	[TestClass]
#if !IS_UNIT_TESTS
	...
	public partial class Given_Border : Context
	{
		...
		[TestMethod]
#if IS_UNIT_TESTS // Broken on Android for now
...
#if true // Broken for tests on Android for now
