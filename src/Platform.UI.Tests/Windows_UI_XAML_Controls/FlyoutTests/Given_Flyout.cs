...
using CodeBrix.Platform.UI.Tests.Windows_UI_XAML_Controls.FlyoutTests.Controls;
...
namespace CodeBrix.Platform.UI.Tests.FlyoutTests //Was previously: Uno.UI.Tests.FlyoutTests
{
	[TestClass]
