...
namespace CodeBrix.Platform.UI.Tests.TimePickerTests; //Was previously: Uno.UI.Tests.TimePickerTests
...
public class Given_TimePicker
{
	...
	public void When_Time_Or_SelectedTime_Changes()
	{
		...
		// The log is built with explicit "\r\n"; the raw string literal below carries whatever line
		// endings the source file is checked out with (CRLF on Windows, LF on Linux/macOS). Normalize
		// both sides so the comparison is line-ending agnostic across platforms.
		Assert.AreEqual("""
