...
using CodeBrix.Platform.UI.Runtime.Skia.Wpf.Rendering;
...
internal class CodeBrixWpfWindowHost : WpfControl, IWpfWindowHost
{
	...
	private readonly Style _style = (Style)XamlReader.Parse(
		...
		<Style
			...
			xmlns:controls="clr-namespace:CodeBrix.Platform.UI.Runtime.Skia.Wpf.UI.Controls;assembly=CodeBrix.Platform.UI.Runtime.Skia.Wpf"
			TargetType="{x:Type controls:CodeBrixWpfWindowHost}">
			<Setter Property="Template">
				<Setter.Value>
					<ControlTemplate TargetType="{x:Type controls:CodeBrixWpfWindowHost}">
						<Grid>
							<Border
								Background="{x:Null}"
	...
	public CodeBrixWpfWindowHost(CodeBrixWpfWindow wpfWindow, MUX.Window winUIWindow)
	{
