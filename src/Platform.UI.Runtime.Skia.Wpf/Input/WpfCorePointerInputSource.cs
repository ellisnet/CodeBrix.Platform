...
using CodeBrix.Platform.UI.Runtime.Skia.Wpf.Constants;
...
#pragma warning restore CS0067
	...
	public WpfCorePointerInputSource(IXamlRootHost host)
	{
		...
		_host = hostControl;
		_renderLayer = host is CodeBrixWpfWindowHost compositeWindowHost ? compositeWindowHost.RenderLayer : hostControl;
