...
namespace CodeBrix.Platform.Extensions.ApplicationModel.DataTransfer
{
	internal class ClipboardExtensions : IClipboardExtension
	{
		...
		{
			CodeBrixWpfWindow.NativeWindowShown += CodeBrixWpfWindow_NativeWindowShown;
		}

		private void CodeBrixWpfWindow_NativeWindowShown(object sender, CodeBrixWpfWindow e)
		{
			CodeBrixWpfWindow.NativeWindowShown -= CodeBrixWpfWindow_NativeWindowShown;
