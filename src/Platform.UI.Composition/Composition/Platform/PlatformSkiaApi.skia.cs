...
internal static class CodeBrixSkiaApi
{
	...
	{
		NativeLibrary.SetDllImportResolver(typeof(CodeBrixSkiaApi).Assembly, DllImportResolver);
	}
	...
	[DllImport(SKIA, CallingConvention = CallingConvention.Cdecl)]
	internal static extern unsafe void sk_textblob_builder_alloc_run_pos(IntPtr builder, IntPtr font, int count, SKRect* bounds, CodeBrixSKRunBufferInternal* runbuffer);
