...
internal struct CodeBrixSKRunBufferInternal : IEquatable<CodeBrixSKRunBufferInternal>
{
	...
	public unsafe readonly bool Equals(CodeBrixSKRunBufferInternal obj)
	{
	...
	{
		if (obj is CodeBrixSKRunBufferInternal obj2)
		{
			return Equals(obj2);
		}
	...
	public static bool operator ==(CodeBrixSKRunBufferInternal left, CodeBrixSKRunBufferInternal right)
	{
