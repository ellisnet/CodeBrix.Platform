...
namespace CodeBrix.Platform.UI.Tasks.Assets //Was previously: Uno.UI.Tasks.Assets
{
	/// <summary>
		...
		public override bool Execute()
		{
			...
			if (MarkerFiles != null)
			{
				...
				foreach (var markerFile in MarkerFiles)
				{
					...
					// Never null: the FullPath well-known metadata is always a rooted file path
