...
namespace CodeBrix.Platform.UI.Tasks.EmbeddedResourceInjector //Was previously: Uno.UI.Tasks.EmbeddedResourceInjector
{
	/// <summary>
	...
	public class EmbeddedResourceInjectorTask_v0 : Microsoft.Build.Utilities.Task
	{
		...
		private string[] BuildReferencesPaths() => ReferencePath
				// Never null: reference paths are full assembly file paths
