...
public partial class HotRestartGenerator : ISourceGenerator
{
	...
	public void Execute(GeneratorExecutionContext context)
	{
		if (!DesignTimeHelper.IsDesignTime(context)
			...
			&& PlatformHelper.IsCodeBrixHead(context))
		{
	...
	private class Generator
	{
		...
		public void Run()
		{
			...
			var document = $$"""
				...
				// <auto-generated>
				// *************************************************************
				// This file has been generated by CodeBrix.Platform.UI ({{nameof(HotRestartGenerator)}})
				// *************************************************************
				// </auto-generated>
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				internal class __CodeBrixHotRestartDelegate : global::Microsoft.Maui.MauiUIApplicationDelegate
				{
		...
		private bool IsGenerationEnabled()
			=> bool.TryParse(_context.GetMSBuildPropertyValue("CodeBrixDisableHotRestartHelperGeneration", "false"), out var result) ? !result : true;
