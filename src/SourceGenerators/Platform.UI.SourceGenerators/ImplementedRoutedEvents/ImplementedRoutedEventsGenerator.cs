...
namespace CodeBrix.Platform.UI.SourceGenerators.ImplementedRoutedEvents; //Was previously: Uno.UI.SourceGenerators.ImplementedRoutedEvents
...
public class ImplementedRoutedEventsGenerator : ISourceGenerator
{
	...
	private class ImplementedRoutedEventsVisitor : SymbolVisitor
	{
		...
		private void ProcessType(INamedTypeSymbol type)
		{
			...
			{
				var builder = new StringBuilder("global::CodeBrix.Platform.UI.Xaml.RoutedEventFlag.None");
				...
				foreach (var @event in _events)
				{
					...
					{
						builder.Append($" | global::CodeBrix.Platform.UI.Xaml.RoutedEventFlag.{@event.Key.Substring("On".Length)}");
					}
				}
		...
		private static void WriteClass(IIndentedStringBuilder builder, INamedTypeSymbol type, string routedEventFlags)
		{
			...
			builder.AppendLineIndented("private static global::CodeBrix.Platform.UI.Xaml.RoutedEventFlag __codebrix_ImplementedRoutedEvents = global::CodeBrix.Platform.UI.Xaml.UIElementGeneratedProxy.RegisterImplementedRoutedEvents(");
