...
namespace CodeBrix.Platform.UI.SourceGenerators.XamlGenerator //Was previously: Uno.UI.SourceGenerators.XamlGenerator
{
	internal static class XamlConstants
	{
		...
		public const string CodeBrixXamlNamespace = "Microsoft.UI.Xaml";
		...
		public static class Types
		{
			...
			public const string IFrameworkElement = CodeBrixXamlNamespace + ".IFrameworkElement";
			public const string FrameworkElement = CodeBrixXamlNamespace + ".FrameworkElement";
			public const string UIElement = CodeBrixXamlNamespace + ".UIElement";
			...
			public const string IDependencyObjectParse = CodeBrixXamlNamespace + ".IDependencyObjectParse";
			...
			public const string NotImplementedAttribute = "CodeBrix.Platform.NotImplementedAttribute";
			...
			// Markup
			public const string MarkupHelper = "CodeBrix.Platform.UI.Helpers.MarkupHelper";
