...
namespace CodeBrix.Platform.UI.SourceGenerators.XamlGenerator.ThirdPartyGenerators.CommunityToolkitMvvm; //Was previously: Uno.UI.SourceGenerators.XamlGenerator.ThirdPartyGenerators.CommunityToolkitMvvm
