	...
	internal partial class XamlFileParser
	{
		...
		private XamlFileDefinition? ParseFile(XamlSource src, string targetFilePath, CancellationToken ct)
		{
			try
			{
				...
				catch (__codebrix::CodeBrix.Platform.Xaml.XamlParseException e)
				{
		...
		private static bool IsSkiaNotConditional(string localName, string namespaceUri)
		{
			...
			// xmlns:skia="http://codebrix.platform/skia#using:SkiaSharp.Views.Windows"
		...
		private __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult IsIncluded(string localName, string namespaceUri)
		{
			if (_includeXamlNamespaces.Contains(localName))
			{
				var result = __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.ForceInclude;
			...
			{
				return __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.ForceExclude;
			}
			...
			if (valueSplit.Length != 2)
			{
				...
				return __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.Default;
			}
			...
			switch (methodName)
			{
				...
				case nameof(ApiInformation.IsApiContractNotPresent):
					...
					return (isIncluded1
						? __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.ForceInclude
						: __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.ForceExclude).WithUpdatedNamespace(namespaceUri);
				...
				case nameof(ApiInformation.IsTypeNotPresent):
					...
					return (isIncluded2
						? __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.ForceIncludeWithCacheDisabled
						: __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.ForceExclude).WithUpdatedNamespace(namespaceUri);
				default:
					return __codebrix::CodeBrix.Platform.Xaml.IsIncludedResult.Default.WithUpdatedNamespace(namespaceUri); // TODO: support IsPropertyPresent
			}
		}
