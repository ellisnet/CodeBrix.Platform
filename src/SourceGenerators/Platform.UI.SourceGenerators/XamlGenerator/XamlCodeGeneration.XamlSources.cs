...
partial class XamlCodeGeneration
{
	private SourceText? GenerateEmbeddedXamlSources(XamlFileDefinition[] files)
	{
		...
		writer.AppendLineInvariantIndented("[assembly: global::System.Reflection.AssemblyMetadata(\"CodeBrix.Platform.HotDesign.HotReloadEmbeddedXamlSourceFilesProvider\", \"{0}.__Sources__.{1}\")]", _defaultNamespace, embeddedXamlSourcesClassName);
		writer.AppendLine();
