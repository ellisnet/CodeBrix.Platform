...
using System.Linq;
using static CodeBrix.Platform.UI.Xaml.XamlFilePathHelper;
...
namespace CodeBrix.Platform.UI.SourceGenerators.XamlGenerator //Was previously: Uno.UI.SourceGenerators.XamlGenerator
{
	internal sealed class XamlGlobalStaticResourcesMap(XamlFileDefinition[] xamlFiles)
	{
		...
		/// <remarks>This is used when building CodeBrix.Platform.UI itself to create a master dictionary of system resources.</remarks>
