...
namespace CodeBrix.Platform.UI.SourceGenerators.BindableTypeProviders //Was previously: Uno.UI.SourceGenerators.BindableTypeProviders
{
	[Generator]
		...
		class Generator
		{
			...
			internal void Generate(GeneratorExecutionContext context)
			{
				try
				{
					...
					_ = bool.TryParse(context.GetMSBuildPropertyValue("CodeBrixDisableBindableTypeProvidersGeneration"), out var disableBindableTypeProvidersGeneration);
					...
					if (validPlatform && !isDesignTime && isApplication && !disableBindableTypeProvidersGeneration)
					{
						...
						// Defaults to 'false'
						_ = bool.TryParse(context.GetMSBuildPropertyValue("CodeBrixXamlResourcesTrimming"), out _xamlResourcesTrimming);
			...
			private string GenerateTypeProviders(IEnumerable<IModuleSymbol> modules)
			{
				...
				writer.AppendLineIndented("// This file has been generated by CodeBrix.Platform.UI (BindableTypeProvidersSourceGenerator)");
				writer.AppendLineIndented("// *****************************************************************************");
				writer.AppendLineIndented("// </auto-generated>");
				writer.AppendLine();
			...
			private void GenerateProviderTable(IndentedStringBuilder writer)
			{
				...
				using (writer.BlockInvariant("public class BindableMetadataProvider : global::CodeBrix.Platform.UI.DataBinding.IBindableMetadataProvider"))
				{
					GenerateTypeTable(writer);

					writer.AppendLineIndented(@"#if DEBUG && !CODEBRIX_DISABLE_KNOWN_MISSING_TYPES");
			...
			private void GenerateType(IndentedStringBuilder writer, INamedTypeSymbol ownerType)
			{
				...
				var typeInfo = new GeneratedTypeInfo(
					...
					hasProperties: properties.Any() || dependencyProperties.Length != 0
				);
				...
				using (writer.BlockInvariant("static class MetadataBuilder_{0:000}", typeInfo.Index))
				{
					...
					using (writer.BlockInvariant("internal static global::CodeBrix.Platform.UI.DataBinding.IBindableType Build()"))
					{
					...
					using (writer.BlockInvariant("internal static global::CodeBrix.Platform.UI.DataBinding.IBindableType Build(global::CodeBrix.Platform.UI.DataBinding.BindableType parent)"))
					{
						RegisterHintMethod($"MetadataBuilder_{typeInfo.Index:000}", ownerType, "CodeBrix.Platform.UI.DataBinding.IBindableType Build(CodeBrix.Platform.UI.DataBinding.BindableType)");

						writer.AppendLineInvariantIndented(
							@"var bindableType = parent ?? new global::CodeBrix.Platform.UI.DataBinding.BindableType({0}, typeof({1}));",
							flattenedProperties
						...
						if (baseType != null)
						{
							var baseTypeMapped = _typeMap.PlatformGetValueOrDefault(baseType);
			...
			{
				writer.AppendLineIndented("private delegate global::CodeBrix.Platform.UI.DataBinding.IBindableType TypeBuilderDelegate();");
				...
				using (writer.BlockInvariant("public global::CodeBrix.Platform.UI.DataBinding.IBindableType GetBindableTypeByFullName(string fullName)"))
				{
					...
					writer.AppendLineIndented(@"return instance as global::CodeBrix.Platform.UI.DataBinding.IBindableType;");
				}

				using (writer.BlockInvariant("public global::CodeBrix.Platform.UI.DataBinding.IBindableType GetBindableTypeByType(global::System.Type type)"))
				{
			...
			{
				writer.AppendLineIndented($"private readonly global::CodeBrix.Platform.UI.DataBinding.IBindableType[] _bindableTypes = new global::CodeBrix.Platform.UI.DataBinding.IBindableType[{types.Length}];");
				writer.AppendLineIndented($"private static global::CodeBrix.Platform.UI.DataBinding.IBindableType _null;");

				using (writer.BlockInvariant("public global::CodeBrix.Platform.UI.DataBinding.IBindableType GetBindableTypeByFullName(string fullName)"))
				{
					writer.AppendLineIndented("ref global::CodeBrix.Platform.UI.DataBinding.IBindableType element = ref _null;");
			...
			private void GenerateLinkerSubstitutionDefinition()
			{
				...
				// <linker>
				//   <assembly fullname="CodeBrix.Platform.UI">
				// 	<type fullname="CodeBrix.Platform.UI.GlobalStaticResources">
