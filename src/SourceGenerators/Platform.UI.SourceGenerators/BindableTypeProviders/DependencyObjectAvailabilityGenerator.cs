...
namespace CodeBrix.Platform.UI.SourceGenerators.BindableTypeProviders //Was previously: Uno.UI.SourceGenerators.BindableTypeProviders
{
	...
	public class DependencyObjectAvailabilityGenerator : ISourceGenerator
	{
		...
		private sealed class Generator
		{
			...
			private bool _isCodeBrixUISolution;
			...
			internal void Generate(GeneratorExecutionContext context)
			{
				try
				{
					...
					if (!bool.TryParse(context.GetMSBuildPropertyValue("CodeBrixXamlResourcesTrimming"), out _xamlResourcesTrimming))
					{
						_xamlResourcesTrimming = false;
					}

					if (!bool.TryParse(context.GetMSBuildPropertyValue("_IsCodeBrixUISolution"), out _isCodeBrixUISolution))
					{
						_isCodeBrixUISolution = false;
					}

					if (validPlatform && (_xamlResourcesTrimming || _isCodeBrixUISolution))
					{
						...
						_additionalLinkerHintAttributeSymbol = context.Compilation.GetTypeByMetadataName("CodeBrix.Platform.Foundation.Diagnostics.CodeAnalysis.AdditionalLinkerHintAttribute");
			...
			private StringBuilderBasedSourceText GenerateTypeProviders(string[] propertyNames)
			{
				...
				writer.AppendLineIndented("// This file has been generated by CodeBrix.Platform.UI (DependencyObjectAvailabilityGenerator)");
				writer.AppendLineIndented("// *****************************************************************************");
				writer.AppendLineIndented("// </auto-generated>");
				writer.AppendLine();
