...
namespace CodeBrix.Platform.UI.SourceGenerators.NativeCtor //Was previously: Uno.UI.SourceGenerators.NativeCtor
{
	[Generator]
		...
		private class SerializationMethodsGenerator : SymbolVisitor
		{
			...
			private void ProcessType(INamedTypeSymbol typeSymbol)
			{
				...
				string GetGeneratedCode(INamedTypeSymbol typeSymbol)
				{
					...
					builder.AppendLineIndented("// This file has been generated by CodeBrix.Platform.UI (NativeCtorsGenerator)");
					builder.AppendLineIndented("// *************************************************************");
					builder.AppendLineIndented("// </auto-generated>");
					builder.AppendLine();
