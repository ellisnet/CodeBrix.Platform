...
namespace CodeBrix.Platform.UI.SourceGenerators.Tests.DependencyPropertyGeneratorTests; //Was previously: Uno.UI.SourceGenerators.Tests.DependencyPropertyGeneratorTests
...
public class Given_DependencyPropertyGenerator
{
			...
			TestState =
			{
				...
				GeneratedSources =
				{
					{ (typeof(DependencyPropertyGenerator), @"Mynamespace.C.cs", SourceText.From("""
						// <auto-generated>
						// ******************************************************************
						// This file has been generated by CodeBrix.Platform.UI (DependencyPropertyGenerator)
						// ******************************************************************
						// </auto-generated>
	...
	public async Task TestGetDefaultValuePresentWithDefaultValueArgument()
	{
		...
		test.ExpectedDiagnostics.Add(
			// CodeBrix.Platform.UI.SourceGenerators.Internal\Uno.UI.SourceGenerators.DependencyObject.DependencyPropertyGenerator\Mynamespace.C.cs(56,10): error CS1029: #error: 'The generated property MyValue cannot contains both a DefaultValue and the GetMyValueDefaultValue() method.'
			DiagnosticResult.CompilerError("CS1029").WithSpan(System.IO.Path.Combine("CodeBrix.Platform.UI.SourceGenerators.Internal", "CodeBrix.Platform.UI.SourceGenerators.DependencyObject.DependencyPropertyGenerator", "Mynamespace.C.cs"), 56, 10, 56, 117).WithArguments("The generated property MyValue cannot contains both a DefaultValue and the GetMyValueDefaultValue() method.")
		);
