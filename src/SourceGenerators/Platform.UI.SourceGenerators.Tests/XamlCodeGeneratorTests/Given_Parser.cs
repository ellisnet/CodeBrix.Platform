...
namespace CodeBrix.Platform.UI.SourceGenerators.Tests.Windows_UI_Xaml_Controls.ParserTests; //Was previously: Uno.UI.SourceGenerators.Tests.Windows_UI_Xaml_Controls.ParserTests
...
public partial class Given_Parser
{
	...
	public async Task When_Event_Handler()
	{
		var xamlFiles = new[]
		{
			new XamlFile("MainPage.xaml",
				"""
				<UserControl
				    x:Class="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml.Controls.XamlEvent_Leak_UserControl"
		...
		var test = new Verify.Test(xamlFiles)
		{
			TestState =
			{
				Sources =
				{
					...
					namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml.Controls
					{
	...
	public async Task When_Skia_Xml_Namespace()
	{
		...
		var test = new Verify.Test(xamlFile)
		{
			...
			ReferenceAssemblies = _Dotnet.Current.ReferenceAssemblies.AddPackages([new PackageIdentity("CodeBrix.Platform.SkiaSharp.Views.MitLicenseForever", "4.151.0")]),
		}.AddGeneratedSources();
	...
	public async Task When_Event_On_TopLevel_Not_DependencyObject()
	{
		...
		var test = new Verify.Test(xamlFile)
		{
			...
			ReferenceAssemblies = _Dotnet.Current.WithCodeBrixPackage("1.0.214.1259"),
		}.AddGeneratedSources();
