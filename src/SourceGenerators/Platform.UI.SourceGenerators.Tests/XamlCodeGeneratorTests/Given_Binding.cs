...
namespace CodeBrix.Platform.UI.SourceGenerators.Tests.Windows_UI_Xaml_Data.BindingTests; //Was previously: Uno.UI.SourceGenerators.Tests.Windows_UI_Xaml_Data.BindingTests
...
public class Given_Binding
{
	...
	{
		var test = new TestSetup(xamlFileName: "Binding_Xaml_Object_With_Common_Properties.xaml", subFolder: Path.Combine("Platform.UI.Tests", "Windows_UI_Xaml_Data", "BindingTests", "Controls"));
	...
	{
		var test = new TestSetup(xamlFileName: "Binding_Xaml_Object_With_Xaml_Object_Properties.xaml", subFolder: Path.Combine("Platform.UI.Tests", "Windows_UI_Xaml_Data", "BindingTests", "Controls"));
		await Verify.AssertXamlGenerator(test);
	}
	...
	{
		var test = new TestSetup(xamlFileName: "Binding_ElementName_In_Template.xaml", subFolder: Path.Combine("Platform.UI.Tests", "Windows_UI_Xaml_Data", "BindingTests", "Controls"))
		{
			PreprocessorSymbols =
			{
				"CODEBRIX_REFERENCE_API",
			},
		};
		await Verify.AssertXamlGenerator(test);
	}
