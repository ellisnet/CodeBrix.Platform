...
namespace CodeBrix.Platform.Roslyn; //Was previously: Uno.Roslyn
...
/// </remarks>
public sealed class CodeBrixNamedTypeSymbolDisplayVisitor : SymbolVisitor
{
	private readonly StringBuilder _builder;
	private readonly bool _includeGlobalNamespace;

	public CodeBrixNamedTypeSymbolDisplayVisitor(StringBuilder builder, bool includeGlobalNamespace)
	{
		_builder = builder;
