	...
	public class DependencyPropertyGenerator : IIncrementalGenerator
	{
		...
		public void Initialize(IncrementalGeneratorInitializationContext context)
		{
			var attributedSymbolsProvider = context.SyntaxProvider.ForAttributeWithMetadataName(
				"CodeBrix.Platform.UI.Xaml.GeneratedDependencyPropertyAttribute",
		...
		private void GenerateSource(SourceProductionContext context, ImmutableArray<GenerationCandidateData> dpCandidatesData)
		{
			...
			builder.AppendLineIndented("// This file has been generated by CodeBrix.Platform.UI (DependencyPropertyGenerator)");
			builder.AppendLineIndented("// ******************************************************************");
			builder.AppendLineIndented("// </auto-generated>");
			builder.AppendLine();
			...
			builder.AppendLineIndented("using CodeBrix.Platform.Extensions.Disposables;");
			builder.AppendLineIndented("using System.Runtime.CompilerServices;");
			builder.AppendLineIndented("using CodeBrix.Platform.UI;");
			builder.AppendLineIndented("using CodeBrix.Platform.UI.DataBinding;");
			...
			builder.AppendLineIndented("using CodeBrix.Platform.Diagnostics.Eventing;");
