...
public partial class X11ApplicationHost : SkiaHost, ISkiaApplicationHost, IDisposable
{
	...
	static X11ApplicationHost()
	{
		...
		ApiExtensibility.Register(typeof(CodeBrix.Platform.ApplicationModel.Core.ICoreApplicationExtension), _ => new X11CoreApplicationExtension());
		...
		ApiExtensibility.Register<IXamlRootHost>(typeof(ICodeBrixCorePointerInputSource), o => new X11PointerInputSource(o));
		ApiExtensibility.Register<IXamlRootHost>(typeof(ICodeBrixKeyboardInputSource), o => new X11KeyboardInputSource(o));
		...
		ApiExtensibility.Register<XamlRoot>(typeof(CodeBrix.Platform.Graphics.INativeOpenGLWrapper), xamlRoot => new X11NativeOpenGLWrapper(xamlRoot));

		ApiExtensibility.Register(typeof(ISystemThemeHelperExtension), _ => LinuxSystemThemeHelper.Instance);

		if (Type.GetType("CodeBrix.Platform.UI.MediaPlayer.Skia.X11.X11MediaPlayerPresenterExtension, CodeBrix.Platform.UI.MediaPlayer.Skia.X11") is { } mediaPresenterExtensionType
			&& Type.GetType("CodeBrix.Platform.UI.MediaPlayer.Skia.X11.SharedMediaPlayerExtension, CodeBrix.Platform.UI.MediaPlayer.Skia.X11") is { } mediaExtensionType)
		{
	...
	{
		if (preloadVlc && Type.GetType("CodeBrix.Platform.UI.MediaPlayer.Skia.X11.SharedMediaPlayerExtension, CodeBrix.Platform.UI.MediaPlayer.Skia.X11") is { } mediaExtensionType)
		{
