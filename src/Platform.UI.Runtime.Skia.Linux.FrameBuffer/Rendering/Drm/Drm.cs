...
{
	internal enum DrmModeConnection
	{
	...
	internal static unsafe class LibDrm
	{
		...
		public struct drmModeModeInfo
		{
			...
			public Size Resolution => new Size(hdisplay, vdisplay);
		}
		...
		[DllImport(libdrm)]
		public static extern int drmModePageFlip(int fd, uint crtc_id, uint fb_id,
