...
namespace CodeBrix.Platform.UI.XamlHost; //Was previously: Uno.UI.XamlHost
...
public static partial class XamlApplicationExtensions
{
	...
	/// a new <see cref="CodeBrix.Platform.UI.XamlHost.XamlApplication" /> instance is created and returned.
	/// </summary>
