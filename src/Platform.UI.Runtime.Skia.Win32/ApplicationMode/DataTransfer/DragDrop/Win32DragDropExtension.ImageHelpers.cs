...
internal partial class Win32DragDropExtension
{
	...
	private static Microsoft.UI.Xaml.Media.Imaging.BitmapImage? LoadImageFromFile(string filePath)
	{
		try
		{
			...
			codebrixBitmap.SetSource(fileStream.AsRandomAccessStream());
	...
	private static unsafe Microsoft.UI.Xaml.Media.Imaging.BitmapImage? ConvertDibToCodeBrixBitmapImage(HGLOBAL handle)
	{
		try
		{
