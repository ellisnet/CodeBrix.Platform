...
using CodeBrix.Platform.UI.UI.Input.Internal;
...
public class Win32Host : SkiaHost, ISkiaApplicationHost
{
	...
	static Win32Host()
	{
		...
		ApiExtensibility.Register<IXamlRootHost>(typeof(ICodeBrixKeyboardInputSource),
		...
		if (Type.GetType("CodeBrix.Platform.UI.MediaPlayer.Skia.Win32.Win32MediaPlayerPresenterExtension, CodeBrix.Platform.UI.MediaPlayer.Skia.Win32") is { } mediaPresenterExtensionType)
		{
		...
		if (Type.GetType("CodeBrix.Platform.UI.MediaPlayer.Skia.Win32.SharedMediaPlayerExtension, CodeBrix.Platform.UI.MediaPlayer.Skia.Win32") is { } mediaExtensionType)
		{
	...
	{
		if (preloadVlc && Type.GetType("CodeBrix.Platform.UI.MediaPlayer.Skia.Win32.SharedMediaPlayerExtension, CodeBrix.Platform.UI.MediaPlayer.Skia.Win32") is { } mediaExtensionType)
		{
