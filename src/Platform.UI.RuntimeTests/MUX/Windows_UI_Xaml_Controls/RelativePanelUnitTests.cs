#if (HAS_CODEBRIX || HAS_CODEBRIX_WINUI) && !WINAPPSDK
...
namespace CodeBrix.Platform.UI.RuntimeTests.MUX.Windows_UI_Xaml_Controls //Was previously: Uno.UI.RuntimeTests.MUX.Windows_UI_Xaml_Controls
{
	[RunsOnUIThread]
	[TestClass]
