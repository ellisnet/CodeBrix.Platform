...
// MUX Reference controls\dev\CommandBarFlyout\APITests\CommandBarFlyoutTests.cs, tag winui3/release/1.7.3, commit 65718e2813a90fc900e8775d2ddc580b268fcc2f
...
public class CommandBarFlyoutTests : MUXApiTestBase
{
	...
	private async Task OpenFlyout(CommandBarFlyout flyout, Button flyoutTarget)
	{
		...
		var openedEvent = new CodeBrixAutoResetEvent(false);
	...
	private async Task CloseFlyout(CommandBarFlyout flyout)
	{
		...
		var closedEvent = new CodeBrixAutoResetEvent(false);
