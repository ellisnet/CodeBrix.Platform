...
namespace Microsoft.UI.Xaml.Tests.MUXControls.ApiTests.RepeaterTests
{
	...
	public class EffectiveViewportTests : MUXApiTestBase
	{
		...
		public async Task ValidateBasicScrollViewerScenario()
		{
			...
			var viewChangeCompletedEvent = new CodeBrixAutoResetEvent(false);
			ScrollViewer scrollViewer = null;
			CodeBrixManualResetEvent viewChanged = new CodeBrixManualResetEvent(false);
			CodeBrixManualResetEvent layoutMeasured = new CodeBrixManualResetEvent(false);
		...
		public async Task ValidateTwoScrollViewerScenarioAsync()
		{
			...
			var horizontalViewChangeCompletedEvent = new CodeBrixAutoResetEvent(false);
			var verticalViewChangeCompletedEvent = new CodeBrixAutoResetEvent(false);
		...
		public async Task CanGrowCacheBufferWithScrollViewerAsync()
		{
			...
			var fullCacheEvent = new CodeBrixManualResetEvent(initialState: false);
		...
		public async Task CanBringIntoViewElementsAsync()
		{
			...
			ScrollViewer scroller = null;
			ItemsRepeater repeater = null;
			var rootLoadedEvent = new CodeBrixAutoResetEvent(initialState: false);
			var effectiveViewChangeCompletedEvent = new CodeBrixAutoResetEvent(initialState: false);
			var viewChangeCompletedEvent = new CodeBrixAutoResetEvent(initialState: false);
		...
		private static VirtualizingLayout GetMonitoringLayout(Size desiredSize, List<Rect> realizationRects, CodeBrixManualResetEvent layoutMeasured = null)
		{
