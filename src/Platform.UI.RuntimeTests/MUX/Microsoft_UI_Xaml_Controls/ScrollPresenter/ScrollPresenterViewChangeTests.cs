...
partial class ScrollPresenterTests : MUXApiTestBase
{
	...
	public async Task BasicOffsetChanges()
	{
		...
		CodeBrixAutoResetEvent scrollPresenterLoadedEvent = new CodeBrixAutoResetEvent(false);
	...
	[Ignore("Zoom is not yet supported in CodeBrix.")]
	...
	[Ignore("Fails in CodeBrix, waiting forever on ViewChanged")]
	public async Task SuccessiveAdditionalScrollVelocities()
	{
		ScrollPresenter scrollPresenter = null;
		Rectangle rectangleScrollPresenterContent = null;
		CodeBrixAutoResetEvent scrollPresenterLoadedEvent = new CodeBrixAutoResetEvent(false);
		CodeBrixAutoResetEvent scrollPresenterViewChangedEvent = new CodeBrixAutoResetEvent(false);
		CodeBrixAutoResetEvent scrollPresenterViewChangeOperationEvent1 = new CodeBrixAutoResetEvent(false);
		CodeBrixAutoResetEvent scrollPresenterViewChangeOperationEvent2 = new CodeBrixAutoResetEvent(false);
	...
	public async Task BasicOffsetsChangeCancelation()
	{
		...
		Rectangle rectangleScrollPresenterContent = null;
		CodeBrixAutoResetEvent scrollPresenterLoadedEvent = new CodeBrixAutoResetEvent(false);
		CodeBrixAutoResetEvent scrollPresenterViewChangeOperationEvent = new CodeBrixAutoResetEvent(false);
	...
	private async Task ConsecutiveOffsetJumps(bool waitForFirstCompletion)
	{
		...
		Rectangle rectangleScrollPresenterContent = null;
		CodeBrixAutoResetEvent scrollPresenterLoadedEvent = new CodeBrixAutoResetEvent(false);
		CodeBrixAutoResetEvent[] scrollPresenterViewChangeOperationEvents = null;
		...
		RunOnUIThread.Execute(() =>
		{
			scrollPresenterViewChangeOperationEvents = new CodeBrixAutoResetEvent[3];
			scrollPresenterViewChangeOperationEvents[0] = new CodeBrixAutoResetEvent(false);
			scrollPresenterViewChangeOperationEvents[1] = new CodeBrixAutoResetEvent(false);
			scrollPresenterViewChangeOperationEvents[2] = new CodeBrixAutoResetEvent(false);
	...
	private async Task ConsecutiveScrollAndZoomJumps(bool isScrollRelative, bool isZoomRelative, bool waitForFirstCompletion)
	{
		...
		RunOnUIThread.Execute(() =>
		{
			scrollPresenterViewChangeOperationEvents = new CodeBrixAutoResetEvent[2];
			scrollPresenterViewChangeOperationEvents[0] = new CodeBrixAutoResetEvent(false);
			scrollPresenterViewChangeOperationEvents[1] = new CodeBrixAutoResetEvent(false);
	...
	private ScrollPresenterOperation StartScrollTo(
		...
		ScrollingAnimationMode animationMode,
		ScrollingSnapPointsMode snapPointsMode,
		CodeBrixAutoResetEvent scrollPresenterViewChangeOperationEvent)
	{
	...
	private async Task WaitForEvent(string logComment, CodeBrixManualOrAutoResetEvent eventWaitHandle)
	{
