...
#pragma warning restore CS0414
	...
	public async Task VerifyScrollPresenterAttachedProperties()
	{
		//using (PrivateLoggingHelper privateSVLoggingHelper = new PrivateLoggingHelper("ScrollView", "ScrollPresenter"))
		{
			...
			CodeBrixAutoResetEvent scrollViewLoadedEvent = new CodeBrixAutoResetEvent(false);
			CodeBrixAutoResetEvent scrollViewUnloadedEvent = new CodeBrixAutoResetEvent(false);
	...
	public async Task VerifyAnchorCandidateRegistration()
	{
		//using (PrivateLoggingHelper privateSVLoggingHelper = new PrivateLoggingHelper("ScrollView", "ScrollPresenter"))
		{
			...
			Rectangle rectangleScrollViewContent = null;
			CodeBrixAutoResetEvent scrollViewLoadedEvent = new CodeBrixAutoResetEvent(false);
			CodeBrixAutoResetEvent scrollViewAnchorRequestedEvent = new CodeBrixAutoResetEvent(false);
	...
	private void SetupDefaultUI(
		ScrollView scrollView,
		Rectangle rectangleScrollViewContent = null,
		CodeBrixAutoResetEvent scrollViewLoadedEvent = null,
		CodeBrixAutoResetEvent scrollViewUnloadedEvent = null,
	...
	private static bool CodeBrixIsDebuggerPresent()
	{
