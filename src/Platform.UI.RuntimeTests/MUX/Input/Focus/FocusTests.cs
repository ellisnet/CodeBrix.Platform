...
namespace CodeBrix.Platform.UI.RuntimeTests.MUX.Input.Focus //Was previously: Uno.UI.RuntimeTests.MUX.Input.Focus
{
	[TestClass]
	[RequiresFullWindow]
	public class FocusTests
	{
		...
		[Ignore("This test does not work yet in CodeBrix, as we cannot simulate keyboard input.")]
		[TestMethod]
