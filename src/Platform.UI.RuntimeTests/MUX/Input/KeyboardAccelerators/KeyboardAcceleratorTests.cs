...
using FocusHelper = CodeBrix.Platform.UI.RuntimeTests.MUX.Input.Focus.FocusHelper;

#if !HAS_CODEBRIX_WINUI
using Microsoft.UI.Xaml.Tests.Common;
#endif

namespace CodeBrix.Platform.UI.RuntimeTests.MUX.Input.KeyboardAccelerators; //Was previously: Uno.UI.RuntimeTests.MUX.Input.KeyboardAccelerators
		...
		const string rootPanelXaml =
				@"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <ListView x:Name='listView'>
                          ...
                          <ListViewItem x:Name='lvItem'>CodeBrix</ListViewItem>
                        </ListView>
                    </StackPanel>";
...
#pragma warning disable CS0108 // Member hides inherited member; missing new keyword
	...
	{
		private readonly CodeBrixAutoResetEvent resetEvent = new CodeBrixAutoResetEvent(false);
