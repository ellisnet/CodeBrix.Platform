...
/// </summary>
public abstract class CodeBrixManualOrAutoResetEvent : IDisposable
{
	private protected bool _wasSet;

	protected CodeBrixManualOrAutoResetEvent(bool initialState)
	...
	public async Task<bool> WaitOne(TimeSpan timeout)
	{
		...
		{
			// CodeBrixAutoResetEvent does not support -1 for infinite timeout.
...
public sealed class CodeBrixManualResetEvent : CodeBrixManualOrAutoResetEvent
{
	public CodeBrixManualResetEvent(bool initialState) : base(initialState)
	{
	}
...
public sealed class CodeBrixAutoResetEvent : CodeBrixManualOrAutoResetEvent
{
	public CodeBrixAutoResetEvent(bool initialState) : base(initialState)
	{
	}
