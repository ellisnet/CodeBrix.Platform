...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_Storage.Streams //Was previously: Uno.UI.RuntimeTests.Tests.Windows_Storage.Streams
{
	[TestClass]
	public class Given_RandomAccessStreamReference
	{
		private const string _codebrixStaticTestFileContent = "https://platform.uno/\r\n";
		...
		public async Task When_FromUri()
		{
			...
			Assert.AreEqual(_codebrixStaticTestFileContent, actual);
		}
