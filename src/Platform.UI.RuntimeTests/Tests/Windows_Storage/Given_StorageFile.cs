...
using CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_Storage.Streams;
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests //Was previously: Uno.UI.RuntimeTests.Tests
{
	...
	public class Given_StorageFile
	{
		...
		{
			var uri = new Uri($"ms-appx:///CodeBrix.Platform.UI.RuntimeTests/Assets/TransientAsset01.txt");
