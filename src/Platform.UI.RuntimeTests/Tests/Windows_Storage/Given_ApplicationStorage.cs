...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_Storage //Was previously: Uno.UI.RuntimeTests.Tests.Windows_Storage
{
	[TestClass]
	public class Given_ApplicationStorage
	{
		...
		{
			var fileExists = await CodeBrix.Platform.UI.Toolkit.StorageFileHelper.ExistsInPackage("Asset_InvalidFile.xml");
		...
		{
			var fileExists = await CodeBrix.Platform.UI.Toolkit.StorageFileHelper.ExistsInPackage("Assets/Fonts/RoteFlora.ttf");
		...
		{
			var fileExists = await CodeBrix.Platform.UI.Toolkit.StorageFileHelper.ExistsInPackage("Asset_GetFileFromApplicationUriAsync.xml");
		...
		{
			var fileExists = await CodeBrix.Platform.UI.Toolkit.StorageFileHelper.ExistsInPackage("Assets/Icons/menu.png");
