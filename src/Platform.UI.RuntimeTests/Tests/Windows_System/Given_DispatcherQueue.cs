...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_System //Was previously: Uno.UI.RuntimeTests.Tests.Windows_System
{
	[TestClass]
...
#if true // Wasm does not have bg threads yet ...
		[TestMethod]
