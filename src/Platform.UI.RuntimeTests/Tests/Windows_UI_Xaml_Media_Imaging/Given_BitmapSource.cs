...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Media_Imaging //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Media_Imaging
{
	[TestClass]
	[RunsOnUIThread]
