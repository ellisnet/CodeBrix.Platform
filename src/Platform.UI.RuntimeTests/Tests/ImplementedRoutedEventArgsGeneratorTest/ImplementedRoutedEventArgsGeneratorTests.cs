...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.ImplementedRoutedEventArgsGeneratorTest //Was previously: Uno.UI.RuntimeTests.Tests.ImplementedRoutedEventArgsGeneratorTest
{
	[TestClass]
