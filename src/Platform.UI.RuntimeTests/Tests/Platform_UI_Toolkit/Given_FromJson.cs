...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Platform_UI_Toolkit; //Was previously: Uno.UI.RuntimeTests.Tests.Uno_UI_Toolkit
...
<Grid xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
      ...
      xmlns:markup="using:CodeBrix.Platform.UI.Markup"
...
""",
		...
		Assert.AreEqual("CodeBrix Platform", target.Text);
		...
		Assert.AreEqual("CodeBrix Platform", owner["Name"]);
