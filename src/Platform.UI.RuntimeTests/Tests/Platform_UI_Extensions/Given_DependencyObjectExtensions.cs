...
using DependencyObjectExtensions = CodeBrix.Platform.UI.Extensions.DependencyObjectExtensions;

namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Platform_UI_Extensions //Was previously: Uno.UI.RuntimeTests.Tests.Uno_UI_Extensions
{
	[TestClass]
