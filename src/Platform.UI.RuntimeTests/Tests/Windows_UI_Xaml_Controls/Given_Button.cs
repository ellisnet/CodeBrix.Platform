...
#if HAS_CODEBRIX_WINUI || WINAPPSDK || WINUI
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls
{
	...
	public class Given_Button
	{
		...
		public async Task When_Button_Flyout_TemplateBinding()
		{
			try
			{
				var SUT = new CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls.ButtonControls.Button_Flyout_TemplateBinding();
