...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls.ButtonControls //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls.ButtonControls
{
	/// <summary>
