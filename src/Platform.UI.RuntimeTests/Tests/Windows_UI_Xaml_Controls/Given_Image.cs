...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls
{
	...
	public class Given_Image
	{
		...
		{
			string url = "ms-appx:///CodeBrix.Platform.UI.RuntimeTests/Assets/Transitive-ingredient01.png";
			var img = new Image();
		...
		public async Task When_Transitive_Asset_With_Link_Loaded()
		{
			...
			string url = "ms-appx:///CodeBrix.Platform.UI.RuntimeTests/Assets/TransitiveTest/colors300.png";
			var img = new Image();
			var SUT = new BitmapImage(new Uri(url));
			img.Source = SUT;
		...
		[DataRow("ms-appx:///CodeBrix.Platform.UI.RuntimeTests/Assets/couch.svg")]
