...
using CodeBrix.Platform.UI.RuntimeTests.ListViewPages;
...
using static CodeBrix.Platform.UI.Extensions.ViewExtensions;
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls
{
	...
	public partial class Given_ListViewBase // test cases
	{
		...
		public async Task When_Item_GetParentInternal_Include_ListView()
		{
			...
			Assert.IsNull(si.Parent);
			var parent = CodeBrix.Platform.UI.Extensions.DependencyObjectExtensions.GetParentInternal(si, false);
			while (parent is not null && parent is not ListView listView)
			{
				parent = CodeBrix.Platform.UI.Extensions.DependencyObjectExtensions.GetParentInternal(parent, false);
			}
		...
		public async Task When_Smooth_Scrolling()
		{
			...
			// scroll to bottom
			CodeBrix.Platform.UI.Helpers.ListViewHelper.SmoothScrollToIndex(lv, lv.Items.Count - 1);
	...
	public partial class Given_ListViewBase // data class, data-context, view-model, template-selector
	{
		public class KeyedTemplateSelector : DataTemplateSelector
		{
			...
			protected override DataTemplate SelectTemplateCore(object item)
			{
				...
				var template = Templates.PlatformGetValueOrDefault(item);
				return template;
			}
		}
		...
		public class KeyedTemplateSelector<T> : DataTemplateSelector
		{
			...
			protected override DataTemplate SelectTemplateCore(object item)
			{
				...
				var template = Templates.PlatformGetValueOrDefault(itemT);
				return template;
			}
		}
