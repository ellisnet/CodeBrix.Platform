...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Media_Animation.TestPages; //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Media_Animation.TestPages
