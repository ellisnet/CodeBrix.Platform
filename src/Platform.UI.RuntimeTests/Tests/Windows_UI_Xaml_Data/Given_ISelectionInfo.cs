...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Data //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Data
{
	[TestClass]
...
#if HAS_CODEBRIX // On Windows this test fails, because the SelectedIndex remains -1, even though visually the item is selected
		[TestMethod]
		[RunsOnUIThread]
