...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_Foundation.Collections //Was previously: Uno.UI.RuntimeTests.Tests.Windows_Foundation.Collections
{
	[TestClass]
