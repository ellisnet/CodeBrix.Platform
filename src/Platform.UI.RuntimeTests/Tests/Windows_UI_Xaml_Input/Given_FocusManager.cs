...
using CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Input.TestPages;
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Input //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Input
{
	[TestClass]
	public class Given_FocusManager
	{
		...
		public async Task When_FocusChanged_PreventScroll()
		{
			...
			await TestServices.WindowHelper.WaitForIdle();
#if false // wasm needs an additional delay for some reason, probably because of smooth scrolling?
