...
#if HAS_CODEBRIX
using CodeBrix.Platform.UI.Controls.Legacy;
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml
{
	...
	public partial class Given_Control
	{
		...
		public void When_Template_Changes_Should_Not_Be_Materialized_Immediately()
		{
			...
			var controlTemplate = (ControlTemplate)XamlReader.Load("""
				<ControlTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
								 ...
								 xmlns:local="using:CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml">
		...
		[RunsOnUIThread]
#if !__CROSSRUNTIME__
		[Ignore("We override <Measure|Arrange>Override to include padding in ContentControl which is a superclass of UserControl on CodeBrix")]
#endif
		...
		public async Task When_Non_BuiltIn_Control()
		{
			...
			var builtInControls = new[]
			{
				...
				typeof(Thumb),
				typeof(ToggleButton),
				typeof(CodeBrix.Platform.UI.Controls.Legacy.ProgressRing),
			};
		...
		{
			var SUT = XamlHelper.LoadXaml<Grid>("""
				<Grid xmlns:controls="using:Microsoft.UI.Xaml.Controls" xmlns:local="using:CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml">
				<Grid.Resources>
