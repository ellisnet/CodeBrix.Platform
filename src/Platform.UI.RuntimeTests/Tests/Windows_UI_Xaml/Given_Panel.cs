		...
		var grid = (Grid)XamlReader.Load(
			"""
				<Grid
					...
					xmlns:local="using:CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml.Controls"
							...
							<ItemsControl.ItemTemplate>
								<DataTemplate>
									<Grid Background="Black" >
										<Image x:Name="linuxImage" Source="ms-appx:///CodeBrix.Platform.UI.RuntimeTests/Assets/linux.png" />
									</Grid>
								</DataTemplate>
							</ItemsControl.ItemTemplate>
						</ListView>
