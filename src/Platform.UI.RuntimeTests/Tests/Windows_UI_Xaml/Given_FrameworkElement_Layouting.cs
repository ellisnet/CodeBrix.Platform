...
namespace CodeBrix.Platform.UI.Tests.Windows_UI_Xaml.FrameworkElementTests //Was previously: Uno.UI.Tests.Windows_UI_Xaml.FrameworkElementTests
{
	[TestClass]
	[RunsOnUIThread]
...
#if CODEBRIX_HAS_ENHANCED_LIFECYCLE || WINAPPSDK
...
#elif CODEBRIX_HAS_ENHANCED_LIFECYCLE || WINAPPSDK
