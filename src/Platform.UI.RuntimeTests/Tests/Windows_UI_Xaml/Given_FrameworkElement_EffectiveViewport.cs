...
#if HAS_CODEBRIX // LayoutRound isn't public in UWP/WinUI. Ignore that block of code there for now.
...
#if false // same reason as Ignore of EVP_When_ConstrainedInNonScrollableSV
