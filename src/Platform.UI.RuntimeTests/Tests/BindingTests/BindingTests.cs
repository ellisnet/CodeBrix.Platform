...
public partial class BindingTests
{
	...
	{
		if (!CodeBrix.Platform.UI.Xaml.Controls.NativeWindowFactory.SupportsMultipleWindows)
		{
	...
	public async Task When_XBind_Teardown_19641()
	{
		...
		var template = XamlHelper.LoadXaml<DataTemplate>("""
			<DataTemplate xmlns:local="using:CodeBrix.Platform.UI.RuntimeTests.Tests">
