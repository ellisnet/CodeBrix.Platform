...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Media; //Was previously: Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Media
...
public class Given_AcrylicBrush
{
	...
	public async Task When_Drawn()
	{
		...
		await noiseBitmap.SetSourceAsync(typeof(AcrylicBrush).Assembly.GetManifestResourceStream("CodeBrix.Platform.UI.Resources.NoiseAsset256x256.png"));
