...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_Globalization; //Was previously: Uno.UI.RuntimeTests.Tests.Windows_Globalization
...
public class Given_ApplicationLanguages
{
	...
	public void Test_Chinese_With_Script_Subtag()
	{
		...
		ApplicationData.Current.LocalSettings.Values["__CodeBrix.PrimaryLanguageOverride"].Should().Be("zh-Hans-CN");
	}
	...
	public void Test_French_With_Script_Subtag()
	{
		...
		ApplicationData.Current.LocalSettings.Values["__CodeBrix.PrimaryLanguageOverride"].Should().Be("fr-Latn-CA");
	}
}
