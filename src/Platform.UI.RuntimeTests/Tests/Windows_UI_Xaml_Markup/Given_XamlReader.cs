	...
	public partial class Given_XamlReader
	{
		...
		public void When_CustomResDict_NormalProperty() // uno#13099
		{
			var sut = XamlHelper.LoadXaml<Given_XamlReader_CustomResDict>("""
				<local:Given_XamlReader_CustomResDict xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup">
...
""";
		...
		{
			var xamlString = """
				<Style TargetType="FlyoutPresenter" xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup">
		...
		public void When_MarkupExtension_FullName_NodeSyntax()
		{
			var value = XamlHelper.LoadXaml<object>("""
				<local:TestMarkupExtension xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup" />
			""");
		...
		{
			var value = XamlHelper.LoadXaml<object>("""
				<local:TestMarkup xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup" />
			""");
		...
		public void When_MarkupExtension_FullName_AttributeSyntax_Generic()
		{
			var host = XamlHelper.LoadXaml<Border>("""
				<Border Tag="{local:TestMarkupExtension}"
					xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup"
					 />
			""");
		...
		{
			var host = XamlHelper.LoadXaml<TextBlock>("""
				<TextBlock xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup">
					<TextBlock.Inlines>
		...
		public void When_MarkupExtension_ServiceProvider_SelfRoot()
		{
			var provider = XamlHelper.LoadXaml<IXamlServiceProvider>("""
				<local:DebugMarkupExtension xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup"/>
			""");
			//IProvideValueTarget
		...
		public void When_MarkupExtension_ServiceProvider_Nested()
		{
			var setup = XamlHelper.LoadXaml<Grid>("""
				<Grid xmlns:local="CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup">
				...
				XamlHelper.LoadXaml<StackPanel>(
					...
					<ContentControl>
						<ContentControl.ContentTemplate>
							<DataTemplate>
								<Border 
									xmlns:local="using:CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_UI_Xaml_Markup" 
