#nullable enable
#if !HAS_CODEBRIX || XAMARIN_ANDROID
using System;
using System.IO;
using System.Linq;
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_Data.Pdf; //Was previously: Uno.UI.RuntimeTests.Tests.Windows_Data.Pdf
...
{
	private const string PdfDocument_Password_Valid = "CodeBrix";
	private const string PdfDocument_Password_Invalid = "1";
	private const string PdfDocument_Name = "PlatformA4.pdf";
	private const string PdfDocument_Name_Protected = "PlatformA4_Protected.pdf";
	private const string ReferencePageImageUri = "PlatformA4.png";
	private const string ReferencePageImage_ProtectedUri = "PlatformA4_Protected.png";
	...
	public async Task When_Crop()
	{
		...
		PdfDocument? pdfDocument = await PdfDocument.LoadFromStreamAsync(stream);
		await CheckDocumentAsync(pdfDocument, "PlatformA4_Crop.png", new PdfPageRenderOptions()
		{
	...
	public async Task When_Arrange()
	{
		...
		PdfDocument? pdfDocument = await PdfDocument.LoadFromStreamAsync(stream);
		await CheckDocumentAsync(pdfDocument, "PlatformA4_100x141.png", new()
		{
