...
using CodeBrix.Platform.UI.RuntimeTests.Tests.TemplatedParent.Setup;
#if HAS_CODEBRIX
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.TemplatedParent; //Was previously: Uno.UI.RuntimeTests.Tests.TemplatedParent
