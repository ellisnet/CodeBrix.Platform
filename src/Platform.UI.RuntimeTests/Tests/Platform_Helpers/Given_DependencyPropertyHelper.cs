#if HAS_CODEBRIX // DependencyPropertyHelper is only available on Uno
#nullable enable
...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Platform_Helpers; //Was previously: Uno.UI.RuntimeTests.Tests.Uno_Helpers
