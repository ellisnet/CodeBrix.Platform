...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests.Windows_ApplicationModel.Email //Was previously: Uno.UI.RuntimeTests.Tests.Windows_ApplicationModel.Email
{
	[TestClass]
