...
namespace CodeBrix.Platform.UI.RuntimeTests.Tests //Was previously: Uno.UI.RuntimeTests.Tests
{
	...
	public class Given_ResourceLoader
	{
		...
		{
			var SUT = ResourceLoader.GetForViewIndependentUse("CodeBrix.Platform.UI.RuntimeTests/TopLevelNamedRuntimeTests");
		...
		{
			var SUT = ResourceLoader.GetForViewIndependentUse("CodeBrix.Platform.UI.RuntimeTests/Resources");
