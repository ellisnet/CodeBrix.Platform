		...
		public static class WindowHelper
		{
			...
			public static Microsoft.UI.Xaml.Window CurrentTestWindow
			{
				...
				set
				{
					...
					CodeBrix.Platform.UI.Toolkit.DevTools.Input.Finger.TestServices_WindowHelper_CurrentTestWindow = value;
#endif
				}
			}
...
#if false   // Adjust for re-layout failures in When_Inline_Items_SelectedIndex, When_Observable_ItemsSource_And_Added, When_Presenter_Doesnt_Take_Up_All_Space
				await Do();
#else
			...
			internal static void CloseAllSecondaryWindows()
			{
				...
				var windows = CodeBrix.Platform.UI.ApplicationHelper.Windows.ToArray();
