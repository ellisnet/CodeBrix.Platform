...
using CodeBrix.Platform.UI.RuntimeTests.MUX.Helpers;
...
namespace Windows.UI.Tests.Enterprise
{
	...
	public class CommandBarIntegrationTests : BaseDxamlTestClass
	{
...
#if !HAS_CODEBRIX // TODO: Fix these scenarios.
		...
		[Ignore("Bug in CodeBrix: Cannot re-measure during measure phase")]
