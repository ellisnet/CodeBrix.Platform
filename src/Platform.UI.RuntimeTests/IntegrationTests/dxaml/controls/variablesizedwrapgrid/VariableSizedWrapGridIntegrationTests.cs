...
namespace CodeBrix.Platform.UI.RuntimeTests.IntegrationTests.dxaml.controls.variablesizedwrapgrid; //Was previously: Uno.UI.RuntimeTests.IntegrationTests.dxaml.controls.variablesizedwrapgrid
