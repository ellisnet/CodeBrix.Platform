...
internal static class RuntimeTestsPlatformHelper
{
	...
	private static bool IsSkiaWpf()
		=> IsSkiaHostAssembly("CodeBrix.Platform.UI.Runtime.Skia.Wpf");

	private static bool IsSkiaWin32()
		=> IsSkiaHostAssembly("CodeBrix.Platform.UI.Runtime.Skia.Win32");

	private static bool IsSkiaX11()
		=> IsSkiaHostAssembly("CodeBrix.Platform.UI.Runtime.Skia.X11");

	private static bool IsSkiaFrameBuffer()
		=> IsSkiaHostAssembly("CodeBrix.Platform.UI.Runtime.Skia.Linux.FrameBuffer");

	private static bool IsSkiaMacOS()
		=> IsSkiaHostAssembly("CodeBrix.Platform.UI.Runtime.Skia.MacOS");

	private static bool IsSkiaBrowser()
		=> IsSkiaHostAssembly("CodeBrix.Platform.UI.Runtime.Skia.WebAssembly.Browser");
