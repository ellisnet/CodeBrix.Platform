...
namespace CodeBrix.Platform.UI.RuntimeTests.Helpers //Was previously: Uno.UI.RuntimeTests.Helpers
{
	...
	{
		public static AndConstraint<SilverAssertions.Collections.GenericCollectionAssertions<float>> BeEquivalentToWithTolerance<T>(this SilverAssertions.Collections.GenericCollectionAssertions<float> assertions, IEnumerable<float> expected, float tolerance)
		{
			...
			return new AndConstraint<SilverAssertions.Collections.GenericCollectionAssertions<float>>(assertions);
		}
	}
}
