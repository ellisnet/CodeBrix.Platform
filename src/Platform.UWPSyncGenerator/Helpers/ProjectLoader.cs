...
using System.IO;
using System.Xml;
using CodeBrix.Platform.SourceGeneratorTasks.Helpers;
...
using CodeBrix.Platform.UWPSyncGenerator;

namespace CodeBrix.Platform.SourceGeneration.Host //Was previously: Uno.SourceGeneration.Host
{
	public class ProjectLoader
	{
		...
		public static ProjectDetails LoadProjectDetails(string projectFile, string configuration)
		{
			...
			properties["BuildingInsideCodeBrixSourceGenerator"] = "true"; // this will force prevent the task to run recursively
