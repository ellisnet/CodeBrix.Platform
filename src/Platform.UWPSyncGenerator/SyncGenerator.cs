...
using CodeBrix.Platform.UWPSyncGenerator.AttributeGeneration;
		...
		private void WriteType(INamedTypeSymbol type, IndentedStringBuilder b)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						b.AppendLineInvariant($"[global::CodeBrix.Platform.NotImplemented]");
					}
					else
					{
						b.AppendLineInvariant($"[global::CodeBrix.Platform.NotImplemented({allSymbols.GenerateNotImplementedList()})]");
					}
