...
namespace CodeBrix.Platform.WinUI.Runtime.Skia.Wayland.DBus //Was previously: Uno.WinUI.Runtime.Skia.X11.DBus
{
	...
	{
		public CodeBrix.Platform.LinuxDBus.Connection Connection { get; }
		public string Destination { get; }
		public DesktopService(CodeBrix.Platform.LinuxDBus.Connection connection, string destination)
	...
	class DesktopObject
	{
		...
		protected CodeBrix.Platform.LinuxDBus.Connection Connection => Service.Connection;
