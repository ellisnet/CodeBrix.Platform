...
{
	private const string _originSettingsKey = "__CODEBRIX__" + nameof(DiagnosticsOverlay) + "__placement" + nameof(_origin);
	private const string _locationXSettingsKey = "__CODEBRIX__" + nameof(DiagnosticsOverlay) + "__placement" + nameof(_location) + "_X";
	private const string _locationYSettingsKey = "__CODEBRIX__" + nameof(DiagnosticsOverlay) + "__placement" + nameof(_location) + "_Y";
