...
//TODO: We need to make sure that when the CodeBrixXamlHost loses focus, focus is changed in the XamlRoot as well,
...
namespace CodeBrix.Platform.UI.XamlHost.Skia.Wpf //Was previously: Uno.UI.XamlHost.Skia.Wpf
{
	...
	/// </summary>
	partial class CodeBrixXamlHostBase
	{
		/// <summary>
		...
		//    // Bug 17544829: Focus is wrong if the previous element is in a different FocusScope than the CodeBrixXamlHost element.
