...
namespace CodeBrix.Platform.UI.XamlHost.Skia.Wpf //Was previously: Uno.UI.XamlHost.Skia.Wpf
{
	...
	/// assumes that the conversion is between a <see cref="CodeBrixXamlHostBase"/> and its wrapped <see cref="UIElement"/>
	/// and attempts to return the correct instance of each.
	/// </summary>
	public class CodeBrixXamlHostWrapperConverter : IValueConverter, Microsoft.UI.Xaml.Data.IValueConverter
	{
		...
		{
			return (value as CodeBrixXamlHostBase)?.GetUwpInternalObject();
		}
