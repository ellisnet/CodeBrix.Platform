...
namespace CodeBrix.Platform.UI.XamlHost.Skia.Wpf //Was previously: Uno.UI.XamlHost.Skia.Wpf
{
	...
	/// </summary>
	public abstract partial class CodeBrixXamlHostBase : WpfControl, IWpfApplicationHost
	{
		/// <summary>
		...
		/// <summary>
		///     Fired when CodeBrixXamlHost root UWP XAML content has been updated
		/// </summary>
		public event EventHandler ChildChanged;

		/// <summary>
		/// Initializes a new instance of the <see cref="CodeBrixXamlHostBase"/> class.
		/// </summary>
		/// <remarks>
		...
		public CodeBrixXamlHostBase(string typeName)
			: this()
		{
			ChildInternal = CodeBrixTypeFactory.CreateXamlContentByType(typeName);
		...
		protected WUX.UIElement ChildInternal
		{
			...
			set
			{
				...
				if (frameworkElement is not null)
				{
					...
					// to determine if CodeBrixXamlHost needs to re-run layout.
		...
		/// For example, override if your control should be a child of another CodeBrixXamlHostBase-based control.
		/// </summary>
