...
namespace Microsoft.UI.Xaml.Controls
{
	public sealed partial class XamlControlsResources : ResourceDictionary
	{
		...
		public XamlControlsResources()
		{
			...
			CodeBrix.Platform.UI.FluentTheme.GlobalStaticResources.Initialize();
			CodeBrix.Platform.UI.FluentTheme.GlobalStaticResources.RegisterDefaultStyles();
			CodeBrix.Platform.UI.FluentTheme.GlobalStaticResources.RegisterResourceDictionariesBySource();
#endif
			...
			if (ControlsResourcesVersion > MaxSupportedResourcesVersion)
			{
				if (this.Log().IsEnabled(LogLevel.Warning))
				{
					this.Log().LogWarning($"" +
						...
						$"in CodeBrix Platform yet. Falling back to {MaxSupportedResourcesVersion} styles.");
				}
...
#if !__NETSTD_REFERENCE__
			CodeBrix.Platform.UI.FluentTheme.v2.GlobalStaticResources.Initialize();
			CodeBrix.Platform.UI.FluentTheme.v2.GlobalStaticResources.RegisterDefaultStyles();
			CodeBrix.Platform.UI.FluentTheme.v2.GlobalStaticResources.RegisterResourceDictionariesBySource();
#endif
