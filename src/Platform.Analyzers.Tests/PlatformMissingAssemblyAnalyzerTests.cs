...
public class CodeBrixMissingAssemblyAnalyzerTests
{
	...
	private static readonly ImmutableArray<PackageIdentity> _codebrixPackage = [new PackageIdentity("CodeBrix.Platform.ApacheLicenseForever", "1.0.201.336")];
	private static readonly ImmutableArray<PackageIdentity> _codebrixPackageWithLottie = [new PackageIdentity("CodeBrix.Platform.ApacheLicenseForever", "1.0.201.336"), new PackageIdentity("CodeBrix.Platform.Lottie.ApacheLicenseForever", "1.0.201.336")];
