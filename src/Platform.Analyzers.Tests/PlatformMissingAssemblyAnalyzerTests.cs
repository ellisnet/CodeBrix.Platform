...
public class CodeBrixMissingAssemblyAnalyzerTests
{
	...
	private static readonly ImmutableArray<PackageIdentity> _codebrixPackage = [new PackageIdentity("CodeBrix.Platform.ApacheLicenseForever", "1.0.231.233")];
	private static readonly ImmutableArray<PackageIdentity> _codebrixPackageWithLottie = [new PackageIdentity("CodeBrix.Platform.ApacheLicenseForever", "1.0.231.233"), new PackageIdentity("CodeBrix.Platform.Lottie.ApacheLicenseForever", "1.0.231.233")];
