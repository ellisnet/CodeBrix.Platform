...
namespace Microsoft.Web.WebView2.Core
{
	...
	public partial class CoreWebView2BasicAuthenticationResponse
	{
		...
		public string UserName
		{
			get
			{
				throw new global::System.NotImplementedException("The member string CoreWebView2BasicAuthenticationResponse.UserName is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public string Password
		{
			get
			{
				throw new global::System.NotImplementedException("The member string CoreWebView2BasicAuthenticationResponse.Password is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
