...
#if HAS_CODEBRIX // Is building using Uno.UI
using CodeBrix.Platform.Extensions.Collections;
using CodeBrix.Platform.Extensions;
using CodeBrix.Platform.Foundation.Logging;
#endif

#if IS_CODEBRIX // Is inside the Uno.UI project
using _VisibleBoundsPadding = CodeBrix.Platform.UI.Behaviors.InternalVisibleBoundsPadding;
#else
using CodeBrix.Platform.UI.Toolkit.Extensions;
using _VisibleBoundsPadding = CodeBrix.Platform.UI.Toolkit.VisibleBoundsPadding;
#endif

#if IS_CODEBRIX
namespace CodeBrix.Platform.UI.Behaviors //Was previously: Uno.UI.Behaviors
{
	/// <summary>
	/// Internal CodeBrix behavior, use VisibleBoundsPadding instead.
	/// </summary>
	/// <remarks>
	/// This class is located in the same source file as the VisibleBoundsPadding class to avoid code duplication.
	/// This is required to ensure that both CodeBrix.Platform.UI styles and UWP (through CodeBrix.Platform.UI.Toolkit) can use this behavior
	/// and not have to synchronize two code files. The internal implementation is not supposed to be used outside
	/// of the CodeBrix.Platform.UI assembly, CodeBrix.Platform.UI.Toolkit.VisibleBoundsPadding should be used by dependents.
	/// </remarks>
