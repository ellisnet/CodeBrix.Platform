	...
	public class BinderReferenceHolder
	{
...
#if !IS_CODEBRIX
			CodeBrix.Platform.Services.Diagnostics.Performance.Increment(BinderActiveReferencesCounter);
#endif
		...
		public static void LogReferenceStatsWithDetails()
		{
			lock (_holders)
			{
				...
				if (IsEnabled && typeof(BinderReferenceHolder).Log().IsEnabled(CodeBrix.Platform.Foundation.Logging.LogLevel.Information))
				{
		...
		public static void LogReport()
		{
			...
			{
				if (typeof(BinderReferenceHolder).Log().IsEnabled(CodeBrix.Platform.Foundation.Logging.LogLevel.Error))
				{
		...
		{
			if (IsEnabled && this.Log().IsEnabled(CodeBrix.Platform.Foundation.Logging.LogLevel.Debug))
			{
...
#if !IS_CODEBRIX
			CodeBrix.Platform.Services.Diagnostics.Performance.Decrement(BinderActiveReferencesCounter);
			CodeBrix.Platform.Services.Diagnostics.Performance.Increment(BinderCollectedReferencesCounter);
#endif
		}
