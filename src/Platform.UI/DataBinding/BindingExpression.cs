...
namespace Microsoft.UI.Xaml.Data
{
	public partial class BindingExpression : IDisposable
	{
		...
		public object DataContext
		{
			...
			set
			{
					...
					DependencyObjectStore.AreDifferent(_dataContext?.Target, value))
				{
					...
					_dataContext = CodeBrix.Platform.UI.DataBinding.WeakReferencePool.RentWeakReference(this, value);
					ApplyBinding();
					...
					CodeBrix.Platform.UI.DataBinding.WeakReferencePool.ReturnWeakReference(this, previousContext);
				}
			}
		}
		...
		private void UpdateSourceOnXBindBack(object value)
		{
			...
			{
				if (this.Log().IsEnabled(CodeBrix.Platform.Foundation.Logging.LogLevel.Error))
				{
