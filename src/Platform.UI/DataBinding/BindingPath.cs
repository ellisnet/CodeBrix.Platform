...
namespace CodeBrix.Platform.UI.DataBinding //Was previously: Uno.UI.DataBinding
{
	...
	internal partial class BindingPath : IDisposable
	{
		...
		public object? DataContext
		{
			...
			set => SetWeakDataContext(CodeBrix.Platform.UI.DataBinding.WeakReferencePool.RentWeakReference(this, value));
		}
		...
		internal void SetWeakDataContext(ManagedWeakReference weakDataContext)
		{
			if (!_disposed)
			{
				...
				CodeBrix.Platform.UI.DataBinding.WeakReferencePool.ReturnWeakReference(this, previousStorage);
			}
		}
		...
		private static IDisposable? SubscribeToNotifyPropertyChanged(ManagedWeakReference dataContextReference, string propertyName, IPropertyChangedValueHandler propertyChangedValueHandler)
		{
			...
			if (notify != null)
			{
				...
				var newValueActionWeak = CodeBrix.Platform.UI.DataBinding.WeakReferencePool.RentWeakReference(null, propertyChangedValueHandler);
				...
				System.ComponentModel.PropertyChangedEventHandler handler = (s, args) =>
				{
					...
					{
						if (typeof(BindingPath).Log().IsEnabled(CodeBrix.Platform.Foundation.Logging.LogLevel.Debug))
						{
				...
				return Disposable.Create(() =>
				{
					...
					CodeBrix.Platform.UI.DataBinding.WeakReferencePool.ReturnWeakReference(null, newValueActionWeak);
				});
			}
