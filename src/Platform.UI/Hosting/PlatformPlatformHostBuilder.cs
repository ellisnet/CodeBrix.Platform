...
public class CodeBrixPlatformHostBuilder : ICodeBrixPlatformHostBuilder
{
	...
	internal CodeBrixPlatformHostBuilder() { }

	Func<Application>? ICodeBrixPlatformHostBuilder.AppBuilder
	{
		get => _appBuilder;
		set => _appBuilder = value;
	}

	Action? ICodeBrixPlatformHostBuilder.AfterInitAction
	{
		get => _afterInitAction;
		set => _afterInitAction = value;
	}

	void ICodeBrixPlatformHostBuilder.SetAppType<TApplication>()
	...
	void ICodeBrixPlatformHostBuilder.AddHostBuilder(Func<IPlatformHostBuilder> platformHostBuilder)
