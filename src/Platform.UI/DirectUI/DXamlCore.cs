...
namespace DirectUI
{
	internal class DXamlCore
	{
		...
		public CodeBrix.Platform.UI.Xaml.Core.CoreServices GetHandle() => CodeBrix.Platform.UI.Xaml.Core.CoreServices.Instance;
		...
		{
			var contentRootCoordinator = CodeBrix.Platform.UI.Xaml.Core.CoreServices.Instance.ContentRootCoordinator;
