...
namespace CodeBrix.Platform.UI.Controls //Was previously: Uno.UI.Controls
{
	...
	{
		private static DependencyProperty BackButtonForegroundProperty = ToolkitHelper.GetProperty("CodeBrix.Platform.UI.Toolkit.CommandBarExtensions, CodeBrix.Platform.UI.Toolkit", "BackButtonForeground");
		private static DependencyProperty BackButtonIconProperty = ToolkitHelper.GetProperty("CodeBrix.Platform.UI.Toolkit.CommandBarExtensions, CodeBrix.Platform.UI.Toolkit", "BackButtonIcon");
		...
		protected override IEnumerable<IDisposable> Initialize()
		{
			...
			if (Native is CodeBrixNavigationBar codebrixNavigationBar)
			{
				codebrixNavigationBar.SizeChanged += Invalidate;
