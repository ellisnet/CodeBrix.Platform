...
namespace CodeBrix.Platform.UI.Controls //Was previously: Uno.UI.Controls
{
	...
	{
		private static DependencyProperty NavigationCommandProperty = ToolkitHelper.GetProperty("CodeBrix.Platform.UI.Toolkit.CommandBarExtensions, CodeBrix.Platform.UI.Toolkit", "NavigationCommand");
		private static DependencyProperty BackButtonTitleProperty = ToolkitHelper.GetProperty("CodeBrix.Platform.UI.Toolkit.CommandBarExtensions, CodeBrix.Platform.UI.Toolkit", "BackButtonTitle");
