			...
			private static bool IsRightTapGesture(Gesture points, out bool isLongPress)
			{
				switch (points.PointerType)
				{
...
#if false
						if (CodeBrix.Platform.WinRTFeatureConfiguration.GestureRecognizer.InterpretForceTouchAsRightTap
							&& isLeftTap
					...
					case PointerDeviceType.Mouse:
						...
						if (CodeBrix.Platform.WinRTFeatureConfiguration.GestureRecognizer.InterpretMouseLeftLongPressAsRightTap
