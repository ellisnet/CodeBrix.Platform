...
using CodeBrix.Platform.UI.Xaml.Rendering;
using CodeBrix.Platform.UI.Xaml.Core.Rendering;
...
namespace Microsoft.UI.Xaml.Input
{
	public partial class FocusManager : IFocusManager
	{
		...
		/// </summary>
		/// <remarks>
		/// Original code checks for "shutting down", which is not supported in CodeBrix,
