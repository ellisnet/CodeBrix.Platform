...
namespace CodeBrix.Platform.UI.Xaml.Input //Was previously: Uno.UI.Xaml.Input
{
	internal static partial class FocusProperties
	{
...
#if false // TODO Uno specific: NativeScrollContentPresenter does not return its children
		...
		/// </summary>
		internal static bool GetCaretBrowsingModeEnable() => CodeBrixForceGetTextBlockForAccessibility;
