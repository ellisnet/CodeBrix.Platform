...
namespace Microsoft.UI.Xaml.Input
{
	public sealed partial class PointerRoutedEventArgs : RoutedEventArgs, IHandleableRoutedEventArgs, CoreWindow.IPointerEventArgs, IDragEventSource
	{
		...
		/// </summary>
		/// <remarks>For CODEBRIX_HAS_MANAGED_POINTERS, we should move this to the aggregated manipulation support in the InputManager.</remarks>
		...
		internal bool IsPointCoordinatesOver(UIElement element)
			=> new Rect(default, global::System.Numerics.VectorExtensions.ToSize(element.ActualSize)).Contains(GetCurrentPoint(element).Position);
