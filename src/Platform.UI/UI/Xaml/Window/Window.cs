...
#pragma warning disable RS0030 // CoreWindow is banned
	...
	/// to prove it is intentional (the property is null throughout CodeBrix.Platform).
	/// </summary>
...
#if false // We normally call SetHost from the NativeWindowWrapper on DesktopXamlSource targets, but for WASM we put it here.
