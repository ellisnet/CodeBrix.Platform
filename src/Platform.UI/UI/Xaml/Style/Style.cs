...
namespace Microsoft.UI.Xaml
{
	...
	public partial class Style
	{
		...
		private readonly static Dictionary<Type, StyleProviderHandler> _lookup = new(CodeBrix.Platform.Extensions.Core.Comparison.FastTypeComparer.Default);
		private readonly static Dictionary<Type, Style> _defaultStyleCache = new(CodeBrix.Platform.Extensions.Core.Comparison.FastTypeComparer.Default);
		private readonly static Dictionary<Type, StyleProviderHandler> _nativeLookup = new(CodeBrix.Platform.Extensions.Core.Comparison.FastTypeComparer.Default);
		private readonly static Dictionary<Type, Style> _nativeDefaultStyleCache = new(CodeBrix.Platform.Extensions.Core.Comparison.FastTypeComparer.Default);
		...
		/// <remarks>This is an CodeBrix-specific method, normally only called from Xaml-generated code.</remarks>
