...
internal readonly struct ParsedText : IParsedText
{
		...
		SKCanvas canvas, float y, SKPaint paint)
	{
			...
			SKCanvas canvas, float y, SKPaint paint)
		{
			...
			var textBlobHandle = CodeBrixSkiaApi.sk_textblob_builder_make(_textBlobBuilder.Handle);
			CodeBrixSkiaApi.sk_canvas_draw_text_blob(canvas.Handle, textBlobHandle, 0f, y, paint.Handle);
			CodeBrixSkiaApi.sk_textblob_unref(textBlobHandle);
		}
	}
