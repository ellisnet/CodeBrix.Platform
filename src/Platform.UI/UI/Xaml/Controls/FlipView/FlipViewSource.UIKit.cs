...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class FlipViewSource : UICollectionViewSource
	{
		...
		public override UICollectionViewCell GetCell(UICollectionView collectionView, NSIndexPath indexPath)
		{
			...
			var cell = (CodeBrix.Platform.UI.Controls.Legacy.ListViewBaseSource.InternalContainer)collectionView.DequeueReusableCell(FlipView.FlipViewItemReuseIdentifier, indexPath);
