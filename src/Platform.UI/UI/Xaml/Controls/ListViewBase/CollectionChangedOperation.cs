...
namespace Microsoft.UI.Xaml.Controls
{
	...
	{
		public CodeBrix.Platform.UI.IndexPath StartingIndex { get; }
		public int Range { get; }
		public NotifyCollectionChangedAction Action { get; }
		public Element ElementType { get; }

		public CodeBrix.Platform.UI.IndexPath EndIndex => ElementType == Element.Item ?
			CodeBrix.Platform.UI.IndexPath.FromRowSection(StartingIndex.Row + Range - 1, StartingIndex.Section) :
			//Group change
			CodeBrix.Platform.UI.IndexPath.FromRowSection(StartingIndex.Row, StartingIndex.Section + Range - 1);

		public CollectionChangedOperation(CodeBrix.Platform.UI.IndexPath startingIndex, int range, NotifyCollectionChangedAction action, Element elementType)
		{
		...
		public CodeBrix.Platform.UI.IndexPath? Offset(CodeBrix.Platform.UI.IndexPath indexPath)
		{
			...
			return CodeBrix.Platform.UI.IndexPath.FromRowSection(row, section);
		}
		...
		public static CodeBrix.Platform.UI.IndexPath? Offset(CodeBrix.Platform.UI.IndexPath index, IEnumerable<CollectionChangedOperation> collectionChanges)
		{
			CodeBrix.Platform.UI.IndexPath? newIndex = index;

			foreach (var change in collectionChanges)
			{
				if (newIndex is CodeBrix.Platform.UI.IndexPath newIndexValue)
				{
		...
		public static int? Offset(int index, IEnumerable<CollectionChangedOperation> collectionChanges) => Offset(CodeBrix.Platform.UI.IndexPath.FromRowSection(index, section: 0), collectionChanges)?.Row;
