...
namespace Microsoft.UI.Xaml.Controls
{
	...
	{
		private const string ReorderOwnerFormatId = DataPackage.CodeBrixPrivateDataPrefix + "__list__view__base__source__";
		private const string ReorderItemFormatId = DataPackage.CodeBrixPrivateDataPrefix + "__list__view__base__source__item__";
		private const string ReorderContainerFormatId = DataPackage.CodeBrixPrivateDataPrefix + "__list__view__base__source__container__";
		private const string DragItemsFormatId = DataPackage.CodeBrixPrivateDataPrefix + "__list__view__base__items__";
...
#pragma warning restore CS0162
...
#if true // This correction doesn't apply on iOS
		...
		private CodeBrix.Platform.UI.IndexPath? CompleteReordering(FrameworkElement draggedContainer, object draggedItem)
