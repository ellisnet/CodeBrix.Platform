...
using CodeBrix.Platform.UI.UI.Xaml.Controls.Layouter;
	...
	public partial class ListViewBaseSource : UICollectionViewSource
	{
		...
		public override UICollectionViewCell GetCell(UICollectionView collectionView, NSIndexPath indexPath)
		{
			...
			)
			{
				...
				var index = Owner?.XamlParent?.GetIndexFromIndexPath(CodeBrix.Platform.UI.IndexPath.FromNSIndexPath(indexPath)) ?? -1;
