...
namespace Microsoft.UI.Xaml.Controls
{
	abstract partial class ManagedVirtualizingPanelLayout : DependencyObject
	{
		...
		/// </summary>
		protected CodeBrix.Platform.UI.IndexPath? GetNextUnmaterializedItem(GeneratorDirection fillDirection, CodeBrix.Platform.UI.IndexPath? currentMaterializedItem)
		{
