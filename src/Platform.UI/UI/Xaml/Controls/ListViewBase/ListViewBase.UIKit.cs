...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class ListViewBase
	{
		...
		/// <summary>
		/// This CodeBrix-only flag sets whether the native list animates collection changes (insertions, deletions, etc). The default is true.
		/// </summary>
		[CodeBrix.Platform.CodeBrixOnly]
		public bool UseCollectionAnimations { get; set; } = true;

		private bool _animateScrollIntoView = CodeBrix.Platform.UI.FeatureConfiguration.ListViewBase.AnimateScrollIntoView;
