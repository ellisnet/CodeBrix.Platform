...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class MultilineTextBoxView : UITextView, ITextBoxView, DependencyObject, IFontScalable, IUIScrollView
	{
		...
		private WeakReference<CodeBrix.Platform.UI.Controls.Window> _window;
		...
		public MultilineTextBoxView(TextBox textBox)
		{
			...
			_window = new WeakReference<CodeBrix.Platform.UI.Controls.Window>(textBox.FindFirstParent<CodeBrix.Platform.UI.Controls.Window>());
			InitializeBinder();
			Initialize();
		}
		...
		internal void ScrollToCursor()
		{
			...
			if (window == null)
			{
				...
				window = _textBox.GetTarget().FindFirstParent<CodeBrix.Platform.UI.Controls.Window>();
				_window = new WeakReference<CodeBrix.Platform.UI.Controls.Window>(window);
			}
