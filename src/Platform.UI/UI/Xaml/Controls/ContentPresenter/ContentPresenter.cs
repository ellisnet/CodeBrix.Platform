...
#elif CODEBRIX_REFERENCE_API || IS_UNIT_TESTS
...
#endif
{
	...
	public void UpdateContentTemplateRoot()
	{
		...
		if (TemplateManager.IsDataTemplateDynamicUpdateEnabled)
		{
			...
			CodeBrix.Platform.UI.TemplateUpdateSubscription.Attach(this, dataTemplate, OnCurrentTemplateUpdated);
		}
...
#if CODEBRIX_SUPPORTS_NATIVEHOST
		if (IsNativeHost)
		{
