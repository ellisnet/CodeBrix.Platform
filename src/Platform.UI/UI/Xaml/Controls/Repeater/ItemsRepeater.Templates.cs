	...
	private bool HandleDynamicTemplateUpdate(object oldValue, object newValue)
	{
		...
		if (m_isLayoutInProgress)
		{
			...
			if (CodeBrix.Platform.UI.TemplateManager.IsDataTemplateDynamicUpdateEnabled)
			{
				...
				if (newValue is DataTemplate layoutDataTemplate)
				{
					...
					CodeBrix.Platform.UI.TemplateUpdateSubscription.Attach(this, layoutDataTemplate, RefreshAllItemsForTemplateUpdate);
				}
			}
		...
		if (newValue is DataTemplate newDataTemplate)
		{
			...
			templateCanBeUpdated =
				CodeBrix.Platform.UI.TemplateUpdateSubscription.Attach(this, newDataTemplate, RefreshAllItemsForTemplateUpdate);
		}
