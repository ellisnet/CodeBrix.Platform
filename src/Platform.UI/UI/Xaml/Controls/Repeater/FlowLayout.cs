...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class FlowLayout : VirtualizingLayout, IFlowLayoutAlgorithmDelegates
	{
			...
			out double avgCountInLine)
		{
			...
			flowState.Platform_LastKnownAverageLineSize = avgLineSize;
		...
		{
			if (state is FlowLayoutState { Platform_LastKnownAverageLineSize: > 0 } flowState)
			{
				var elementSize = flowState.Platform_LastKnownAverageLineSize;
