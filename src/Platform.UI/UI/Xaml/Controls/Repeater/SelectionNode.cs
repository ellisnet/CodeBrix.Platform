...
#if !HAS_CODEBRIX // Finalizer is intentionally not included in Uno Platform. we are unhooking the handlers explicitly instead of relying on shared_ptr.
		~SelectionNode()
		{
...
#if HAS_CODEBRIX // In Uno Platform we are unhooking the handlers explicitly instead of relying on shared_ptr.
