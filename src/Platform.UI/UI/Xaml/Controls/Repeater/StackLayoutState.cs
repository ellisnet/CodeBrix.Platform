...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class StackLayoutState
	{
		...
		internal double Platform_LastKnownAverageElementSize;
		internal int Platform_LastKnownRealizedElementsCount;
		internal int Platform_LastKnownItemsCount;
		internal Size Platform_LastKnownDesiredSize;
		// Uno workaround [END]
