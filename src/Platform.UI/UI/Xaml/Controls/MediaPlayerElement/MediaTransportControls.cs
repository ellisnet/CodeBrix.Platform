	...
	partial class MediaTransportControls // helper methods
	{
		...
		private bool ShouldHideControlPanel()
		{
			...
			var result =
				...
				!m_hasError &&
#endif
#if HAS_CODEBRIX // m_shouldDismissControlPanel is set when the playback state changes from buffering to playing and on VLC-backed implementations of MPE, seeking causes a sequence of buffer-play-buffer-play states which keep showing and hiding the controls. cf. https://github.com/unoplatform/uno/issues/20346
