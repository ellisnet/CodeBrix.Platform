...
namespace Microsoft.UI.Xaml.Controls
{
...
#endif
	{
		...
		private protected override Line CreateLine(GeneratorDirection fillDirection, double extentOffset, double availableBreadth, CodeBrix.Platform.UI.IndexPath nextVisibleItem)
		{
