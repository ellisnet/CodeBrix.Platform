...
public partial class NavigationView
{
	...
	private readonly SerialDisposable m_leftNavItemsRepeaterCodeBrixBeforeElementPreparedRevoker = new();
	private readonly SerialDisposable m_topNavItemsRepeaterCodeBrixBeforeElementPreparedRevoker = new();
	private readonly SerialDisposable m_leftNavFooterMenuItemsRepeaterCodeBrixBeforeElementPreparedRevoker = new();
	private readonly SerialDisposable m_topNavFooterMenuItemsRepeaterCodeBrixBeforeElementPreparedRevoker = new();
	private readonly SerialDisposable m_topNavOverflowItemsRepeaterCodeBrixBeforeElementPreparedRevoker = new();
