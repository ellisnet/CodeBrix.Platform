...
public partial class NavigationView : ContentControl
{
	...
	internal void UnhookEventsAndClearFields(bool isFromDestructor = false)
	{
		...
		m_leftNavItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = null;
		m_leftNavFooterMenuItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = null;
		m_topNavFooterMenuItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = null;
		m_topNavItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = null;
		m_topNavOverflowItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = null;
#endif
...
#if IS_CODEBRIX
				//TODO: Uno specific - remove when #4689 is fixed
				leftNavRepeater.CodeBrixBeforeElementPrepared += OnRepeaterCodeBrixBeforeElementPrepared;
				m_leftNavItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = Disposable.Create(() => leftNavRepeater.CodeBrixBeforeElementPrepared -= OnRepeaterCodeBrixBeforeElementPrepared);
#endif
...
#if IS_CODEBRIX
				//TODO: Uno specific - remove when #4689 is fixed
				topNavRepeater.CodeBrixBeforeElementPrepared += OnRepeaterCodeBrixBeforeElementPrepared;
				m_topNavItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = Disposable.Create(() => topNavRepeater.CodeBrixBeforeElementPrepared -= OnRepeaterCodeBrixBeforeElementPrepared);
#endif
...
#if IS_CODEBRIX
				//TODO: Uno specific - remove when #4689 is fixed
				topNavListOverflowRepeater.CodeBrixBeforeElementPrepared += OnRepeaterCodeBrixBeforeElementPrepared;
				m_topNavOverflowItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = Disposable.Create(() => topNavListOverflowRepeater.CodeBrixBeforeElementPrepared -= OnRepeaterCodeBrixBeforeElementPrepared);
#endif
...
#if IS_CODEBRIX
				//TODO: Uno specific - remove when #4689 is fixed
				leftFooterMenuNavRepeater.CodeBrixBeforeElementPrepared += OnRepeaterCodeBrixBeforeElementPrepared;
				m_leftNavFooterMenuItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = Disposable.Create(() => leftFooterMenuNavRepeater.CodeBrixBeforeElementPrepared -= OnRepeaterCodeBrixBeforeElementPrepared);
#endif
...
#if IS_CODEBRIX
				//TODO: Uno specific - remove when #4689 is fixed
				topFooterMenuNavRepeater.CodeBrixBeforeElementPrepared += OnRepeaterCodeBrixBeforeElementPrepared;
				m_topNavFooterMenuItemsRepeaterCodeBrixBeforeElementPreparedRevoker.Disposable = Disposable.Create(() => topFooterMenuNavRepeater.CodeBrixBeforeElementPrepared -= OnRepeaterCodeBrixBeforeElementPrepared);
#endif
...
#if false // Uno workaround: The arrange is async on iOS, ActualHeight is not set yet. This would constraints the footer to MaxHeight 0.
...
#if !IS_CODEBRIX // disable animations for now
...
#if !HAS_CODEBRIX // TODO Uno specific: Revokers are implemented differently than in WinUI.
