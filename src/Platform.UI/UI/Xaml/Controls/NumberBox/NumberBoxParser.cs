...
internal partial class NumberBoxParser
{
	...
	static (double, int) GetNextNumber(string input, INumberParser numberParser)
	{
		...
		[UnconditionalSuppressMessage("Trimming", "IL2067", Justification = "`CodeBrix.Platform.UI.SourceGenerators/BindableTypeProviders` / `BindableMetadata.g.cs` ensures the type exists.")]
