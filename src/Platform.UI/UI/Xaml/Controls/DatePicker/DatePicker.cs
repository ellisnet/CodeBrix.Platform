...
#if HAS_CODEBRIX // TODO Uno specific: Window activation handling to accomodate for WinUI multiwindow, original implementation can be ported when DatePicker is updated from WinUI 3 sources.
