...
namespace Microsoft.UI.Xaml.Controls
{
	...
	internal partial class CalendarLayoutStrategyImpl : LayoutStrategyBase
	{
		...
		public partial struct IndexCorrectionTable
		{
			...
			private (int first, int second)[] m_indexCorrectionTable => codebrix_m_indexCorrectionTable ??= new (int, int)[2];
			private (int first, int second)[] codebrix_m_indexCorrectionTable;
		};
