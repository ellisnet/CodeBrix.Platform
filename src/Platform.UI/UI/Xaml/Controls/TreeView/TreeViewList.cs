...
#if HAS_CODEBRIX // #15214: workaround for initial selection being lost
	...
	protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
	{
		...
		if (IsContentMode)
		{
			...
			if (itemContainer.IsExpanded != itemNode.IsExpanded)
			{
				...
				{
#if !HAS_CODEBRIX // Uno Specific: this is actually a bug in WinUI, copy WinUI's fix when https://github.com/microsoft/microsoft-ui-xaml/issues/9549 is resolved
