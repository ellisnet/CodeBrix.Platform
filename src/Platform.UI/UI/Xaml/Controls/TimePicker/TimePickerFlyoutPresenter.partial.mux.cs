...
#if HAS_CODEBRIX // Because DateTimeFormatter does not match WinAppSDK it is returning 0 for 12-hour clock hour 12. #22207
...
#if HAS_CODEBRIX // Because DateTimeFormatter does not match WinAppSDK, period may be ommitted even if clock identifier is set. #19349
