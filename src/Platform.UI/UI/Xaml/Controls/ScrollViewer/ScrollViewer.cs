...
#pragma warning restore CS0649 // Field is never assigned to, and will always have its default value
		...
		private static bool IsAnimationEnabled => CodeBrix.Platform.UI.Helpers.WinUI.SharedHelpers.IsAnimationsEnabled();
		...
		public ScrollViewer()
		{
			...
			UpdatesMode = CodeBrix.Platform.UI.Xaml.Controls.ScrollViewer.GetUpdatesMode(this);
			InitializePartial();
		}
...
#pragma warning restore 649 // unused member for Unit tests
		...
		/// <summary>
		/// Cached value of <see cref="CodeBrix.Platform.UI.Xaml.Controls.ScrollViewer.UpdatesModeProperty"/>,
		/// in order to not access the DP on each scroll (perf considerations)
		/// </summary>
		internal CodeBrix.Platform.UI.Xaml.Controls.ScrollViewerUpdatesMode UpdatesMode { get; set; }
		...
		private ScrollBarVisibility ComputeNativeScrollBarVisibility(double scrollable, ScrollBarVisibility visibility, ScrollMode mode, ScrollBar? managedScrollbar)
			=> (scrollable, visibility, mode, managedScrollbar) switch
			{
				...
				(_, _, _, null) when CodeBrix.Platform.UI.Xaml.Controls.ScrollViewer.GetShouldFallBackToNativeScrollBars(this) => visibility,
		...
		public
#if !CODEBRIX_REFERENCE_API && !IS_UNIT_TESTS
			new
#endif
			void Add(View view)
		{
		...
		internal void OnPresenterScrolled(double horizontalOffset, double verticalOffset, bool isIntermediate)
		{
			...
			if (isIntermediate && UpdatesMode != CodeBrix.Platform.UI.Xaml.Controls.ScrollViewerUpdatesMode.Synchronous)
			{
				RequestUpdate();
...
#if true // ScrollContentPresenter.[Horizontal|Vertical]Offset not implemented on Android and iOS
