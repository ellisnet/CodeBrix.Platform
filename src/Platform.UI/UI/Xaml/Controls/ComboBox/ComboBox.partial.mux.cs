...
partial class ComboBox
{
	...
	private void OnOpen()
	{
		...
		if (m_tpPopupPart is not null)
		{
#if HAS_CODEBRIX // Force load children
...
#if HAS_CODEBRIX // TODO Uno: This code is customized version to working navigation handling discrepancies and CharacterReceived support missing.
...
#if HAS_CODEBRIX // CharacterReceived is not supported yet, handle it here.
...
#if HAS_CODEBRIX // TODO:MZ: Validate if this is still needed!
...
#if HAS_CODEBRIX // Not ported yet
