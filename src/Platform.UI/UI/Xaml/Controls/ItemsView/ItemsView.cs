...
partial class ItemsView : Control
{
	...
	public ItemsView()
	{
		...
		{
			this.Log().Error("ItemsView is not supported on this platform (iOS, Android). For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
		}
#endif
