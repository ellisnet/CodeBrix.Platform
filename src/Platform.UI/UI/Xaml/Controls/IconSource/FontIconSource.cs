...
public partial class FontIconSource : IconSource
{
	...
	public static DependencyProperty FontFamilyProperty { get; } =
		DependencyProperty.Register(nameof(FontFamily), typeof(FontFamily), typeof(FontIconSource), new FrameworkPropertyMetadata(new FontFamily(CodeBrix.Platform.UI.FeatureConfiguration.Font.SymbolsFont), OnPropertyChanged));
