...
namespace Microsoft.UI.Xaml.Controls
{
	...
	{
		private static DependencyProperty IsDestructiveProperty = ToolkitHelper.GetProperty("CodeBrix.Platform.UI.Toolkit.MenuFlyoutItemExtensions, CodeBrix.Platform.UI.Toolkit", "IsDestructive");
