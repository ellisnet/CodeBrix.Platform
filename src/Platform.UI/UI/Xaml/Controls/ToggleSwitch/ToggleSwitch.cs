...
namespace Microsoft.UI.Xaml.Controls
{
	...
	public partial class ToggleSwitch : Control, IFrameworkTemplatePoolAware
	{
		...
		private bool IsNativeTemplate
		{
			...
			{
#if false
				return this.FindFirstChild<CodeBrix.Platform.UI.Controls.BindableSwitchCompat>() != null;
#elif false
				return this.FindFirstChild<CodeBrix.Platform.UI.Views.Controls.BindableUISwitch>() != null;
#else
				return false;
#endif
			}
