...
namespace Microsoft.UI.Xaml.Data
{
	...
	internal enum ResourceUpdateReason
	{
		None = 0,
		/// <summary>
		/// A static resource that could not be resolved at compile time, and should retry at loading. (This is something of a patch for compatibility gaps between CodeBrix and WinUI)
		/// </summary>
