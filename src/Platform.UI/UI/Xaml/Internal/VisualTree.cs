...
using CodeBrix.Platform.UI.Xaml.Islands;
...
namespace CodeBrix.Platform.UI.Xaml.Core //Was previously: Uno.UI.Xaml.Core
{
	...
	/// </summary>
	/// <remarks>
	/// CodeBrix Platform implementation is mostly a stub for now, needs to be expanded upon.
	/// </remarks>
	internal partial class VisualTree
	{
		private const int VisualDiagnosticsRootZIndex = CodeBrixTopZIndex - 1;
		...
		private readonly CodeBrixFocusInputHandler? _focusInputHandler;
		...
		public VisualTree(CoreServices coreServices, Color backgroundColor, UIElement? rootElement, ContentRoot contentRoot)
		{
			...
			_focusInputHandler = new CodeBrixFocusInputHandler(RootElement);
		}

		internal CodeBrixFocusInputHandler? CodeBrixFocusInputHandler => _focusInputHandler;
