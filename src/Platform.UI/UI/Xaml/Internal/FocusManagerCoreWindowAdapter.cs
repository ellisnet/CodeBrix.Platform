...
#if HAS_CODEBRIX // Uno specific: WinUI implementation just returns false.
	internal override bool ShouldDepartFocus(FocusNavigationDirection direction)
	{
#if false // In case of WASM we want to depart focus when tabbing out of the root visual.
