...
namespace Microsoft.UI.Xaml
{
	...
	partial class UIElement
	{
		...
		private GestureRecognizer CreateGestureRecognizer()
		{
			...
			if (CodeBrix.Platform.WinRTFeatureConfiguration.GestureRecognizer.ShouldProvideHapticFeedback)
			{
		...
		// Not implemented for native pointers (i.e. !CODEBRIX_HAS_MANAGED_POINTERS)
		...
		private bool SetOver(PointerRoutedEventArgs args, bool isOver, BubblingContext ctx)
		{
			...
			if (isOver) // Entered
			{
				...
				if (!wasOver)
				{
					...
					CodeBrix.Platform.Helpers.AccessibilityAnnouncer.AnnouncePolite(text);
				}
#endif
