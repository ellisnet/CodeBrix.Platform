...
namespace Microsoft.UI.Xaml
{
	internal static class FrameworkElementExtensions
	{
		...
		private static DependencyProperty GetDependencyPropertyFromFields(object element, string property)
		{
			...
			[UnconditionalSuppressMessage("Trimming", "IL2070", Justification = "`CodeBrix.Platform.UI.SourceGenerators/BindableTypeProviders` / `BindableMetadata.g.cs` ensures the field exists.")]
			[UnconditionalSuppressMessage("Trimming", "IL2075", Justification = "`CodeBrix.Platform.UI.SourceGenerators/BindableTypeProviders` / `BindableMetadata.g.cs` ensures the field exists.")]
		...
		private static DependencyProperty GetDependencyPropertyFromProperties(object element, string property)
		{
			...
			[UnconditionalSuppressMessage("Trimming", "IL2070", Justification = "`CodeBrix.Platform.UI.SourceGenerators/BindableTypeProviders` / `BindableMetadata.g.cs` ensures the property exists.")]
			[UnconditionalSuppressMessage("Trimming", "IL2075", Justification = "`CodeBrix.Platform.UI.SourceGenerators/BindableTypeProviders` / `BindableMetadata.g.cs` ensures the property exists.")]
