...
using static CodeBrix.Platform.Extensions.Matrix3x2Extensions;
using static CodeBrix.Platform.Extensions.EnumerableExtensions;
...
namespace Microsoft.UI.Xaml.Media
{
	public partial class VisualTreeHelper
	{
		...
		/// </summary>
		/// <remarks>
		/// This method is present to support adding native view types on Android, iOS and MacOS to CodeBrix's visual tree.
		///
...
#nullable enable
		...
		private static void TRACE(FormattableString msg)
		{
			...
			if (_trace is { })
			{
				...
				_trace.Append(' ');
				_trace.Append(CodeBrix.Platform.Extensions.FormattableExtensions.ToStringInvariant(msg));
				_trace.Append("\r\n");
			}
#endif
		}
