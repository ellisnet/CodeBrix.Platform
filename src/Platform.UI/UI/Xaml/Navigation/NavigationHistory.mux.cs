...
internal partial class NavigationHistory
{
	...
	internal void CommitSetNavigationState(NavigationCache pNavigationCache)
	{
		...
		[UnconditionalSuppressMessage("Trimming", "IL2057", Justification = "`CodeBrix.Platform.UI.SourceGenerators/BindableTypeProviders` / `BindableMetadata.g.cs` ensures the type exists.")]
