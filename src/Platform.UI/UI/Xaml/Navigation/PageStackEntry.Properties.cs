...
[assembly: UnconditionalSuppressMessage("Trimming", "IL2111", Scope = "member",
	...
	Justification = "From the `SourcePageTypeProperty` assignment; `typeof(Type)` triggers IL2111 regarding `Type.TypeInitializer`, but CodeBrix doesn't use `Type.TypeInitializer`!")]
