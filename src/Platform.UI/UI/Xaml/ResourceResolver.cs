...
namespace CodeBrix.Platform.UI //Was previously: Uno.UI
{
	...
	public static class ResourceResolver
	{
...
#else
			CodeBrix.Platform.UI.GlobalStaticResources.MasterDictionary;
#endif
		...
		internal static void SetSymbolsFontFamily()
		{
			...
			{
				var symbolsFontFamily = new FontFamily(global::CodeBrix.Platform.UI.FeatureConfiguration.Font.SymbolsFont);
		...
		/// (ie not application XAML, and not CodeBrix.Platform.UI XAML)
		/// </summary>
