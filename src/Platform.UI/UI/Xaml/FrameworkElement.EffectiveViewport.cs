	...
	partial class FrameworkElement : IFrameworkElement_EffectiveViewport
	{
...
#if !IS_NATIVE_ELEMENT && !CODEBRIX_HAS_ENHANCED_LIFECYCLE && !__NETSTD_REFERENCE__ // We rely on Enter/Leave with enhanced lifecycle instead of Loaded/Unloaded.
		...
		IDisposable IFrameworkElement_EffectiveViewport.RequestViewportUpdates(bool isInternalUpdate, IFrameworkElement_EffectiveViewport child)
		{
			global::System.Diagnostics.Debug.Assert(
				CodeBrix.Platform.UI.Extensions.DependencyObjectExtensions.GetChildren(this).OfType<IFrameworkElement_EffectiveViewport>().Contains(child)
