...
using CodeBrix.Platform.UI.WinRT.Extensions.UI.Popups;
...
namespace Microsoft.UI.Xaml
{
	...
	public partial class Application
	{
		...
		static Application()
		{
			...
			CodeBrix.Platform.Helpers.DispatcherTimerProxy.SetDispatcherTimerGetter(() => new DispatcherTimer());
			CodeBrix.Platform.Helpers.VisualTreeHelperProxy.SetCloseAllFlyoutsAction(() =>
			{
		...
		internal void SyncRequestedThemeFromXamlRoot(XamlRoot xamlRoot)
		{
			...
			if (xamlRoot.Content is FrameworkElement fe)
			{
				...
				SetExplicitRequestedTheme(CodeBrix.Platform.UI.Extensions.ElementThemeExtensions.ToApplicationThemeOrDefault(theme));
			}
		}
