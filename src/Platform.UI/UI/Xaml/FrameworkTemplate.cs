...
namespace Microsoft.UI.Xaml
{
	...
	public partial class FrameworkTemplate : DependencyObject, IFrameworkTemplateInternal
	{
		...
		/// only when CodeBrix.Platform.UI.TemplateManager enables "template materialization override mode".
		...
		/// should remain unchanged. See CodeBrix.Platform.UI.TemplateManager for details.
		/// </summary>
		/// <remarks>
