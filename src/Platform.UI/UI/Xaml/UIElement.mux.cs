...
namespace Microsoft.UI.Xaml
{
	public partial class UIElement
	{
		...
		{
#if HAS_CODEBRIX // Uno specific: In case of WinUI this logic is called only
			...
			ref bool handledShouldNotImpedeTextInput)
		{
			...
			{
				pCollection = CodeBrix.Platform.UI.Extensions.DependencyObjectExtensions.GetChildren(pElement);
			}
