...
internal static class BorderHelper
{
	...
	{
		@this.BorderVisual.CornerRadius = @this.CornerRadius.ToCodeBrixCompositionCornerRadius();
	}
	...
	public static void UpdateBorderThickness(this IBorderInfoProvider @this)
	{
		...
		@this.BorderVisual.BorderThickness = thickness.ToCodeBrixCompositionThickness();
	}
