...
namespace Microsoft.UI.Xaml
{
	...
	public sealed partial class DependencyProperty
	{
			...
			bool attached)
		{
			...
			_flags |= ownerType.Assembly.Equals(typeof(DependencyProperty).Assembly) ? Flags.IsCodeBrixType : Flags.None;
		...
		/// <summary>
		/// Determines if the property storage should be backed by a <see cref="CodeBrix.Platform.UI.DataBinding.ManagedWeakReference"/>
		/// </summary>
		...
		/// <exception cref="InvalidOperationException">A property with the same name has already been declared for the ownerType</exception>
		/// <remarks>
		/// This method is to ensure that all CodeBrix controls defined dependency properties are using <see cref="FrameworkPropertyMetadata"/>.
		/// This is achieved by banning the other public overload in CodeBrix.Platform.UI directory.
		/// </remarks>
...
#pragma warning restore RS0030 // Do not used banned APIs
		...
		/// <summary>
		/// Determines if the owner type is declared by CodeBrix.Platform.UI
		/// </summary>
		internal bool IsCodeBrixType
			=> (_flags & Flags.IsCodeBrixType) != 0;
		...
		internal object GetDefaultValue(DependencyObject referenceObject, Type forType)
		{
			...
			if (this == DoubleAnimation.ToProperty)
			{
				...
				{
					return CodeBrix.Platform.UI.Helpers.Boxes.NullableDoubleBoxes.One;
				}
				else if (referenceObject is FadeOutThemeAnimation)
				{
					return CodeBrix.Platform.UI.Helpers.Boxes.NullableDoubleBoxes.Zero;
				}
			}
		...
		private enum Flags
		{
			...
			/// <summary>
			/// Set when the property type is declared in CodeBrix.Platform.UI
			/// </summary>
			IsCodeBrixType = (1 << 4),
