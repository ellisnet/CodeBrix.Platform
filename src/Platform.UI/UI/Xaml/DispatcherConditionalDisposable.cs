...
using CodeBrix.Platform.UI.Common;
...
namespace Microsoft.UI.Xaml
{
	...
	internal abstract class DispatcherConditionalDisposable : ConditionalDisposable
	{
		...
		protected override void TargetFinalized()
		{
			...
			{
				CodeBrix.Platform.UI.Dispatching.NativeDispatcher.Main.Enqueue(
					DispatchedTargetFinalized,
					CodeBrix.Platform.UI.Dispatching.NativeDispatcherPriority.Idle);
			}
		}
