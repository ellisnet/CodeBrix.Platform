...
namespace Microsoft.UI.Xaml
{
	public enum DependencyPropertyValuePrecedences : int
	{
		...
		/// </summary>
		/// <remarks>On CodeBrix, this is actually used for values set by the default style, to allow for them to correctly take precedence over inherited values.</remarks>
		ImplicitStyle,
