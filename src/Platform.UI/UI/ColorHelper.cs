...
public static partial class ColorHelper
{
	...
	public static string ToDisplayName(WindowsColor color)
	{
		...
		//Uno specific
		return global::Windows.ApplicationModel.Resources.ResourceLoader.GetForViewIndependentUse("CodeBrix.Platform.UI/Resources").GetString(id.ToStringInvariant());
