...
using CodeBrix.Platform.UI.Content;
...
#if HAS_CODEBRIX_WINUI // These interfaces are not currently implemented and the Generated partial does not exist in UWP build.
