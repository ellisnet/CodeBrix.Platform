...
namespace CodeBrix.Platform.UI //Was previously: Uno.UI
{
	public static class FeatureConfiguration
	{
		...
		public static class ComboBox
		{
			...
			/// </remarks>
			public static CodeBrix.Platform.UI.Xaml.Controls.DropDownPlacement DefaultDropDownPreferredPlacement { get; set; } = CodeBrix.Platform.UI.Xaml.Controls.DropDownPlacement.Auto;
		...
		public static class DataTemplateSelector
		{
			...
			/// When set to true, only `SelectTemplateCore(object)` is called (CodeBrix's legacy mode).
			/// </summary>
		...
		public static class FrameworkElement
		{
			...
			/// will not, which is how WinUI behaves. Set to true to restore the legacy behavior.
			/// </summary>
			...
			/// Default value is false, setting it to true will restore the legacy behavior.
			/// </summary>
		...
		public static class Popup
		{
			...
			/// Use this property to override that default if your code depends on the
			/// legacy behavior where it defaulted to true.
			/// </summary>
		...
		public static class ListViewBase
		{
			...
			/// </summary>
			/// <remarks>
			/// Regardless of the value set, <see cref="CodeBrix.Platform.UI.Helpers.ListViewHelper.InstantScrollToIndex(Microsoft.UI.Xaml.Controls.ListViewBase, int)"/>
			/// and <see cref="CodeBrix.Platform.UI.Helpers.ListViewHelper.SmoothScrollToIndex(Microsoft.UI.Xaml.Controls.ListViewBase, int)"/>
		...
		{
			/// <summary>
			/// Sets this value to remove item animation for <see cref="CodeBrixRecyclerView"/>. This prevents <see cref="CodeBrixRecyclerView"/>
			...
			/// <summary>
			/// Sets a value indicating whether the item snapping will be implemented by the native <see cref="AndroidX.RecyclerView.Widget.SnapHelper"/> or by CodeBrix.
			/// </summary>
		...
		{
			/// <summary>
			/// When enabled, the Position property of the Manipulation&gt;Started|Delta|Complete&lt;**Routed**EventArgs
			/// is in absolute coordinate space instead of being relative to the Container.
			/// </summary>
		...
		{
			/// <summary>
			/// Determines if CodeBrix.Platform.UI should be using native styles for controls that have
		...
		public static class TextBox
		{
			...
			/// CodeBrix skia-based TextBox implementation.
			/// </summary>
		...
		{
			/// <summary>
			/// This defines the default value of the <see cref="CodeBrix.Platform.UI.Xaml.Controls.ScrollViewer.UpdatesModeProperty"/>.
		...
		public static class UIElement
		{
			...
			///
			/// Note: for release builds of CodeBrix.Platform, if the flag is set, attributes will be set on loading and *not* updated if
			/// the values change subsequently. This restriction doesn't apply to debug CodeBrix.Platform builds.
			/// </remarks>
		...
		public static class VisualState
		{
			...
			/// </summary>
			/// <remarks>This flag is for backward compatibility and should not be turned on.</remarks>
