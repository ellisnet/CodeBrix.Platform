...
namespace CodeBrix.Platform.UI.Extensions //Was previously: Uno.UI.Extensions
{
	...
	{
		internal static CodeBrix.Platform.UI.Xaml.Core.CoreServices GetContext(this DependencyObject dependencyObject)
		{
			//TODO Uno: Our implementation currently uses a simplified approach.
			return CodeBrix.Platform.UI.Xaml.Core.CoreServices.Instance;
