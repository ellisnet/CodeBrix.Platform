...
public sealed partial class BrowserHtmlElement : IDisposable
{
	...
	private static void CreateHtmlElementNative(string id, nint codebrixElementId, string tagName)
	{
	...
	{
		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.initialize")]
		internal static partial void Initialize();

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.createHtmlElement")]
		internal static partial void CreateHtmlElement(string id, string tagName);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.disposeHtmlElement")]
		internal static partial bool DisposeHtmlElement(string id);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.setStyleString")]
		internal static partial void SetStyleString(string elementId, string name, string value);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.resetStyle")]
		internal static partial void ResetStyle(string elementId, string[] names);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.setClasses")]
		internal static partial void SetClasses(string elementId, string[] classes, int index);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.setUnsetCssClasses")]
		internal static partial void SetUnsetCssClasses(string elementId, string[] classesToUnset);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.setAttribute")]
		internal static partial void SetAttribute(string elementId, string name, string value);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.getAttribute")]
		internal static partial string GetAttribute(string elementId, string name);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.removeAttribute")]
		internal static partial void RemoveAttribute(string elementId, string name);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.setContentHtml")]
		internal static partial void SetContentHtml(string elementId, string html);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.registerNativeHtmlEvent")]
		...
		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.unregisterNativeHtmlEvent")]
		internal static partial void UnregisterNativeHtmlEvent(
			string elementId,
			string eventName,
			[JSMarshalAs<JSType.Any>] object handler);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.invokeJS")]
		internal static partial string InvokeJS(string js);

		[JSImport($"globalThis.CodeBrix.Platform.UI.NativeElementHosting.BrowserHtmlElement.invokeAsync")]
