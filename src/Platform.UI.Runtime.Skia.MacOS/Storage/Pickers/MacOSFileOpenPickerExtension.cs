...
internal class MacOSFileOpenPickerExtension : IFileOpenPickerExtension
{
	...
	{
		var array = NativeCodeBrix.codebrix_pick_multiple_files(_prompt, _identifier, (int)_suggestedStartLocation, _filters, _filters.Length);
	...
	{
		var file = NativeCodeBrix.codebrix_pick_single_file(_prompt, _identifier, (int)_suggestedStartLocation, _filters, _filters.Length);
