...
#import "CDBRXMediaPlayer.h"

static codebrix_mediaplayer_periodic_position_update_fn_ptr codebrix_mediaplayer_periodic_position_update;
inline codebrix_mediaplayer_periodic_position_update_fn_ptr codebrix_mediaplayer_get_periodic_position_update_callback(void)
{
    return codebrix_mediaplayer_periodic_position_update;
}

static codebrix_mediaplayer_rate_changed_fn_ptr codebrix_mediaplayer_rate_changed;
inline codebrix_mediaplayer_rate_changed_fn_ptr codebrix_mediaplayer_get_rate_changed_callback(void)
{
    return codebrix_mediaplayer_rate_changed;
}

static codebrix_mediaplayer_video_dimension_changed_fn_ptr codebrix_mediaplayer_video_dimension_changed;
inline codebrix_mediaplayer_video_dimension_changed_fn_ptr codebrix_mediaplayer_get_video_dimension_changed_callback(void)
{
    return codebrix_mediaplayer_video_dimension_changed;
}

static codebrix_mediaplayer_duration_changed_fn_ptr codebrix_mediaplayer_duration_changed;
inline codebrix_mediaplayer_duration_changed_fn_ptr codebrix_mediaplayer_get_duration_changed_callback(void)
{
    return codebrix_mediaplayer_duration_changed;
}

static codebrix_mediaplayer_ready_to_play_fn_ptr codebrix_mediaplayer_ready_to_play;
inline codebrix_mediaplayer_ready_to_play_fn_ptr codebrix_mediaplayer_get_ready_to_play_callback(void)
{
    return codebrix_mediaplayer_ready_to_play;
}

static codebrix_mediaplayer_buffering_progress_changed_fn_ptr codebrix_mediaplayer_buffering_progress_changed;
inline codebrix_mediaplayer_buffering_progress_changed_fn_ptr codebrix_mediaplayer_get_buffering_progress_changed_callback(void)
{
    return codebrix_mediaplayer_buffering_progress_changed;
}

static codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_on_media_opened;
inline codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_get_on_media_opened(void)
{
    return codebrix_mediaplayer_on_media_opened;
}

static codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_on_media_ended;
inline codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_get_on_media_ended(void)
{
    return codebrix_mediaplayer_on_media_ended;
}

static codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_on_media_failed;
inline codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_get_on_media_failed(void)
{
    return codebrix_mediaplayer_on_media_failed;
}

static codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_on_media_stalled;
inline codebrix_mediaplayer_event_fn_ptr codebrix_mediaplayer_get_on_media_stalled(void)
{
    return codebrix_mediaplayer_on_media_stalled;
}
...
{
    codebrix_mediaplayer_periodic_position_update = periodic_position_update;
    codebrix_mediaplayer_rate_changed = rate_changed;
    codebrix_mediaplayer_video_dimension_changed = video_dimension_changed;
    codebrix_mediaplayer_duration_changed = duration_changed;
    codebrix_mediaplayer_ready_to_play = ready_to_play;
    codebrix_mediaplayer_buffering_progress_changed = buffering_progress_changed;
    codebrix_mediaplayer_on_media_opened = media_opened;
    codebrix_mediaplayer_on_media_ended = media_ended;
    codebrix_mediaplayer_on_media_failed = media_failed;
    codebrix_mediaplayer_on_media_stalled = media_stalled;
}
...
id codebrix_mediaplayer_create(void)
{
    ...
    NSLog(@"codebrix_mediaplayer_create %p", player);
#endif
    return player;
}
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_is_video %p -> %s", media, media.isVideo ? "TRUE" : "FALSE");
#endif
...
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_get_current_time %p -> %g", media, time);
#endif
    return time;
}
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_set_current_time %p -> %g", media, seconds);
#endif
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_set_rate %p -> %g", media, media.player.rate);
#endif
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_set_rate %p -> %g", media, rate);
#endif
...
void codebrix_mediaplayer_set_source(UNOMediaPlayer *media, NSURL *url)
{
    AVPlayerItem* item = [AVPlayerItem playerItemWithURL:url];
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_set_source %p item %p url %@", media, item, url);
#endif
...
void codebrix_mediaplayer_set_source_path(UNOMediaPlayer *media, const char *path)
{
    ...
    codebrix_mediaplayer_set_source(media, url);
}
...
void codebrix_mediaplayer_set_stretch(UNOMediaPlayer *media, Stretch stretch)
{
    ...
    switch(stretch)
    {
        ...
        default:
#if DEBUG_MEDIAPLAYER
            NSLog(@"codebrix_mediaplayer_apply_stretch %p unknown value %d", media, stretch);
#endif
            return;
    }

#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_apply_stretch %p stretch %d -> gravity %@", media, stretch, gravity);
#endif
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_set_volume %p %f", media, volume);
#endif
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_pause %p", media);
#endif
    [media.player pause];
}
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_play %p", media);
#endif
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_stop %p", media);
#endif
    AVPlayer *player = media.player;
    [player pause];
...
void codebrix_mediaplayer_toggle_mute(UNOMediaPlayer *media)
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_toggle_muted %p", media);
#endif
...
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_step_by %p frames %d canStepForward %s canStepBackward %s", media, frames, item.canStepForward ? "true" : "false", item.canStepBackward ? "true" : "false");
#endif
...
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_create_view #%p %@", view, view.layer);
#endif
    return view;
}
...
{
#if DEBUG_MEDIAPLAYER
    NSLog(@"codebrix_mediaplayer_set_view #%p %@ videoPlayer %@", media, view, media.videoLayer);
#endif
...
- (void)setNotifications {
    ...
    timeObserver = [self.player addPeriodicTimeObserverForInterval:CMTimeMake(1, 4) queue:dispatch_get_main_queue() usingBlock:^(CMTime time) {
        ...
        if (self && self.player.currentItem) {
            ...
            codebrix_mediaplayer_get_periodic_position_update_callback()(self, position);
#if DEBUG_MEDIAPLAYER
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context
{
    if ([keyPath isEqualToString:@"duration"]) {
        ...
        if (!CMTIME_IS_INDEFINITE(duration)) {
            ...
            codebrix_mediaplayer_get_duration_changed_callback()(self, seconds);
        }
        ...
        if (item) {
...
#endif
                codebrix_mediaplayer_get_on_media_failed()(self);
                return;
            }
            ...
            if (status == AVPlayerStatusReadyToPlay) {
                ...
                codebrix_mediaplayer_get_ready_to_play_callback()(self, self.player.rate);
             }
...
#endif
                codebrix_mediaplayer_get_on_media_opened()(self);
            }
        } else {
            self.isVideo = NO;
#if DEBUG_MEDIAPLAYER
        ...
        codebrix_mediaplayer_get_buffering_progress_changed_callback()(self, progress);
        ...
        codebrix_mediaplayer_get_rate_changed_callback()(self, self.player.rate);
        ...
        codebrix_mediaplayer_get_video_dimension_changed_callback()(self, width, height);
    } else {
#if DEBUG_MEDIAPLAYER
...
#endif
    codebrix_mediaplayer_get_on_media_ended()(self);
}
...
#endif
    codebrix_mediaplayer_get_on_media_stalled()(self);
}
