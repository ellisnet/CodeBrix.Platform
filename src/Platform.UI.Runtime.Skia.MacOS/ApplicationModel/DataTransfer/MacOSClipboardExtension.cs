...
internal class MacOSClipboardExtension : IClipboardExtension
{
	...
	public static unsafe void Register()
	{
		...
		NativeCodeBrix.codebrix_clipboard_set_content_changed_callback(&ContentChangedCallback);
	}

	public event EventHandler<object>? ContentChanged;

	public void Clear() => NativeCodeBrix.codebrix_clipboard_clear();
	...
	public DataPackageView GetContent()
	{
		...
		NativeCodeBrix.codebrix_clipboard_get_content(ref clipboard);
	...
	private static async Task SetContentAsync(DataPackage content)
	{
		...
		NativeCodeBrix.codebrix_clipboard_set_content(ref clipboard);
	}

	public void StartContentChanged() => NativeCodeBrix.codebrix_clipboard_start_content_changed();

	public void StopContentChanged() => NativeCodeBrix.codebrix_clipboard_stop_content_changed();
