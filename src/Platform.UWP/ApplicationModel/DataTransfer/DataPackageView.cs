...
namespace Windows.ApplicationModel.DataTransfer
{
	public partial class DataPackageView
	{
		...
		public IReadOnlyList<string> AvailableFormats => _data.Keys.Where(k => !k.StartsWith(DataPackage.CodeBrixPrivateDataPrefix, StringComparison.Ordinal)).ToArray();
		...
		public IAsyncOperation<object> GetDataAsync(string formatId)
			// Note: Using this, application can gain access to the data prefixed with DataPackage.CodeBrixPrivateDataKey ... which is acceptable
