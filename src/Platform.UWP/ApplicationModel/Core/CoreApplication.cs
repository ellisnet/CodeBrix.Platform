...
public static partial class CoreApplication
{
	...
	/// native UI elements in non CodeBrix.UWP to resolve the currently set Application theme.
	/// </summary>
	internal static SystemTheme RequestedTheme { get; set; }

	/// <summary>
	/// Gets a value indicating whether the the app is running as a full fledged app or as CodeBrix islands only.
	/// </summary>
