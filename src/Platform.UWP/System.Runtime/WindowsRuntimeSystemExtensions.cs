...
namespace System
{
	public static class WindowsRuntimeSystemExtensions
	{
		...
		private static Task AsTaskCore(this IAsyncAction source, CancellationToken ct)
		{
			...
			if (source is CodeBrix.Platform.UI.Dispatching.UIAsyncOperation operation)
			{
		...
		{
			if (source is CodeBrix.Platform.UI.Dispatching.UIAsyncOperation uiAsyncOperation)
			{
