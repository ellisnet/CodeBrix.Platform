...
public sealed partial class ApplicationData
{
	...
	{
		throw new NotImplementedException("The member StorageFolder ApplicationData.GetPublisherCacheFolder(string folderName) is not implemented in CodeBrix.");
	}

	[CodeBrix.Platform.NotImplemented]
	public Foundation.IAsyncAction ClearPublisherCacheFolderAsync(string folderName)
	{
		throw new NotImplementedException("The member IAsyncAction ApplicationData.ClearPublisherCacheFolderAsync(string folderName) is not implemented in CodeBrix.");
	}

	[CodeBrix.Platform.NotImplemented]
	public static Foundation.IAsyncOperation<ApplicationData> GetForUserAsync(System.User user)
	{
		throw new NotImplementedException("The member IAsyncOperation<ApplicationData> ApplicationData.GetForUserAsync(User user) is not implemented in CodeBrix.");
	}
