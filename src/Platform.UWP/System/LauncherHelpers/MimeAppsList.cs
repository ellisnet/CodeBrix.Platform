...
namespace CodeBrix.Platform.UI.Runtime.Skia.Extensions.System.LauncherHelpers //Was previously: Uno.UI.Runtime.Skia.Extensions.System.LauncherHelpers
{
		...
		private void ParseFile(string location)
		{
			...
			try
			{
				...
				while (!reader.EndOfStream)
				{
					...
					if (SectionMap.TryGetValue(line, out var mappedSection))
					{
							...
							case MimeAppSection.DefaultApplications:
								{
									...
									if (RemovedAssociations.TryGetValue(key, out var removedSet))
									{
										var currentRemoved = removedSet;
