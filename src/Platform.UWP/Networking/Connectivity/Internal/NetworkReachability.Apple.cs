...
#if false false // catalyst https://github.com/xamarin/xamarin-macios/issues/13931
using CoreTelephony;
#endif
...
namespace CodeBrix.Platform.Networking.Connectivity.Internal //Was previously: Uno.Networking.Connectivity.Internal
{
	enum NetworkStatus
	{
		NotReachable,
