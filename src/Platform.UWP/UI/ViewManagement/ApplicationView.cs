...
using CodeBrix.Platform.Devices.Sensors;
...
namespace Windows.UI.ViewManagement
{
	...
	{
		private const string PreferredLaunchViewWidthKey = "__CodeBrix.PreferredLaunchViewSizeKey.Width";
		private const string PreferredLaunchViewHeightKey = "__CodeBrix.PreferredLaunchViewSizeKey.Height";
