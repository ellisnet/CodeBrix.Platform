...
namespace Windows.UI.StartScreen
{
	...
	{
		internal const string CodeBrixShortcutKey = "CodeBrixShortcut";
		internal const string ImagePathKey = "CodeBrixLogoImagePath";
#if false
		internal const string ArgumentsExtraKey = "CodeBrixArguments";
#endif
