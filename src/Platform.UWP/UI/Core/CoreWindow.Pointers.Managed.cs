...
{
	private ICodeBrixCorePointerInputSource? _pointerSource;
	...
	internal void SetPointerInputSource(ICodeBrixCorePointerInputSource source)
	{
	...
	internal ICodeBrixCorePointerInputSource? PointersSource => _pointerSource;
