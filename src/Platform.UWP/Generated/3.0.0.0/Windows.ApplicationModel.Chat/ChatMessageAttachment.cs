...
namespace Windows.ApplicationModel.Chat
{
	...
	public partial class ChatMessageAttachment
	{
		...
		public string Text
		{
			get
			{
				throw new global::System.NotImplementedException("The member string ChatMessageAttachment.Text is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public string MimeType
		{
			get
			{
				throw new global::System.NotImplementedException("The member string ChatMessageAttachment.MimeType is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public uint GroupId
		{
			get
			{
				throw new global::System.NotImplementedException("The member uint ChatMessageAttachment.GroupId is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public global::Windows.Storage.Streams.IRandomAccessStreamReference DataStreamReference
		{
			get
			{
				throw new global::System.NotImplementedException("The member IRandomAccessStreamReference ChatMessageAttachment.DataStreamReference is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public double TransferProgress
		{
			get
			{
				throw new global::System.NotImplementedException("The member double ChatMessageAttachment.TransferProgress is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public global::Windows.Storage.Streams.IRandomAccessStreamReference Thumbnail
		{
			get
			{
				throw new global::System.NotImplementedException("The member IRandomAccessStreamReference ChatMessageAttachment.Thumbnail is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public string OriginalFileName
		{
			get
			{
				throw new global::System.NotImplementedException("The member string ChatMessageAttachment.OriginalFileName is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
