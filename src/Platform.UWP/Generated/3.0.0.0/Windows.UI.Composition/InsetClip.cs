...
namespace Windows.UI.Composition
{
	...
	public partial class InsetClip : global::Windows.UI.Composition.CompositionClip
	{
		...
		public float TopInset
		{
			get
			{
				throw new global::System.NotImplementedException("The member float InsetClip.TopInset is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public float RightInset
		{
			get
			{
				throw new global::System.NotImplementedException("The member float InsetClip.RightInset is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public float LeftInset
		{
			get
			{
				throw new global::System.NotImplementedException("The member float InsetClip.LeftInset is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public float BottomInset
		{
			get
			{
				throw new global::System.NotImplementedException("The member float InsetClip.BottomInset is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
