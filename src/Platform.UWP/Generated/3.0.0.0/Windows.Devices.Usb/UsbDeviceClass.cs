...
namespace Windows.Devices.Usb
{
	...
	public partial class UsbDeviceClass
	{
		...
		public byte? SubclassCode
		{
			get
			{
				throw new global::System.NotImplementedException("The member byte? UsbDeviceClass.SubclassCode is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public byte? ProtocolCode
		{
			get
			{
				throw new global::System.NotImplementedException("The member byte? UsbDeviceClass.ProtocolCode is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public byte ClassCode
		{
			get
			{
				throw new global::System.NotImplementedException("The member byte UsbDeviceClass.ClassCode is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
