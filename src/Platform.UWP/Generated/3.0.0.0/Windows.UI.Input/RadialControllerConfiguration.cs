...
namespace Windows.UI.Input
{
	...
	public partial class RadialControllerConfiguration
	{
		...
		public bool IsMenuSuppressed
		{
			get
			{
				throw new global::System.NotImplementedException("The member bool RadialControllerConfiguration.IsMenuSuppressed is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public global::Windows.UI.Input.RadialController ActiveControllerWhenMenuIsSuppressed
		{
			get
			{
				throw new global::System.NotImplementedException("The member RadialController RadialControllerConfiguration.ActiveControllerWhenMenuIsSuppressed is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public static bool IsAppControllerEnabled
		{
			get
			{
				throw new global::System.NotImplementedException("The member bool RadialControllerConfiguration.IsAppControllerEnabled is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public static global::Windows.UI.Input.RadialController AppController
		{
			get
			{
				throw new global::System.NotImplementedException("The member RadialController RadialControllerConfiguration.AppController is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		{
			throw new global::System.NotImplementedException("The member bool RadialControllerConfiguration.TrySelectDefaultMenuItem(RadialControllerSystemMenuItemKind type) is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
		}
#endif
		...
		{
			throw new global::System.NotImplementedException("The member RadialControllerConfiguration RadialControllerConfiguration.GetForCurrentView() is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
		}
#endif
	}
}
