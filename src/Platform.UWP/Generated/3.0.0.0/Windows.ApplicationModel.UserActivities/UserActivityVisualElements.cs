...
namespace Windows.ApplicationModel.UserActivities
{
	...
	public partial class UserActivityVisualElements
	{
		...
		public string DisplayText
		{
			get
			{
				throw new global::System.NotImplementedException("The member string UserActivityVisualElements.DisplayText is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public string Description
		{
			get
			{
				throw new global::System.NotImplementedException("The member string UserActivityVisualElements.Description is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public global::Windows.UI.Shell.IAdaptiveCard Content
		{
			get
			{
				throw new global::System.NotImplementedException("The member IAdaptiveCard UserActivityVisualElements.Content is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public global::Windows.UI.Color BackgroundColor
		{
			get
			{
				throw new global::System.NotImplementedException("The member Color UserActivityVisualElements.BackgroundColor is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public global::Windows.ApplicationModel.UserActivities.UserActivityAttribution Attribution
		{
			get
			{
				throw new global::System.NotImplementedException("The member UserActivityAttribution UserActivityVisualElements.Attribution is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
		...
		public string AttributionDisplayText
		{
			get
			{
				throw new global::System.NotImplementedException("The member string UserActivityVisualElements.AttributionDisplayText is not implemented. For more information, visit https://github.com/ellisnet/CodeBrix.Platform/blob/main/NOT-IMPLEMENTED.md");
			}
			set
			{
