...
[assembly: ApiExtension(
	...
	typeof(CodeBrix.Platform.UI.WebView.Skia.X11.X11NativeWebViewProvider),
...
public class X11NativeWebView : INativeWebView
{
	...
	private readonly string _title = $"CodeBrix WebView {Random.Shared.Next()}";
	...
	public X11NativeWebView(CoreWebView2 coreWebView2, ContentPresenter presenter)
	{
		...
		var xid = RunOnGtkThread(() =>
		{
			...
			_webview.UserContentManager.RegisterScriptMessageHandler("codebrixWebView");
