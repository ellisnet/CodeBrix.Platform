...
using LineNode = CodeBrix.Platform.UI.AdvancedTextEdit.Document.DocumentLine;

namespace CodeBrix.Platform.UI.AdvancedTextEdit.Document;

//was previously: ICSharpCode.AvalonEdit/Document/LineNode.cs in the AvalonEdit repo (MIT).
