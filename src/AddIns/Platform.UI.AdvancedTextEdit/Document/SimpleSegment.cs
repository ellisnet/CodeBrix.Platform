...
//was previously: ICSharpCode.AvalonEdit/Document/SimpleSegment.cs in the AvalonEdit repo (MIT).
...
public sealed class AnchorSegment : ISegment
{
	...
	public AnchorSegment(TextDocument document, ISegment segment)
		: this(document, ThrowUtil.CheckNotNull(segment, nameof(segment)).Offset, segment.Length)
	{
	}
