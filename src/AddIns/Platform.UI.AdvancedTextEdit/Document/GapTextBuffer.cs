...
//was previously: ICSharpCode.AvalonEdit/Document/GapTextBuffer.cs in the AvalonEdit repo (MIT).
//The whole implementation is commented out upstream (the rope replaced the gap buffer); the
//commented-out code is preserved here unchanged for reference, matching the upstream file.
