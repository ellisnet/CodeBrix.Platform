...
//was previously: ICSharpCode.AvalonEdit/Document/TextUtilities.cs in the AvalonEdit repo (MIT).
//Upstream used the WPF System.Windows.Documents.LogicalDirection enum; here the LogicalDirection
//shim declared in this namespace (Document/LogicalDirection.cs) is used instead. No other
//behavior changed.
...
public static partial class TextUtilities
{
	...
	/// <param name="indentationSize">The size of an indentation unit. See <see cref="AdvancedTextEditOptions.IndentationSize"/>.</param>
