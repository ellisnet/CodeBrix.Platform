...
//was previously: ICSharpCode.AvalonEdit/Snippets/IActiveElement.cs in the AvalonEdit repo (MIT).
//Transliterated unchanged apart from the nullable annotation on Segment (documented as "may be
//null" upstream).
