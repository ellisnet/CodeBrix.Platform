...
//was previously: ICSharpCode.AvalonEdit/Indentation/CSharp/DocumentAccessor.cs in the AvalonEdit repo (MIT).
//Nullability: the current-line text starts as the empty string instead of null before the first
//MoveNext() call, and the dirty-line write-back guards against a not-yet-fetched line. Both are
//unreachable differences in practice - the line can only become dirty after MoveNext() has run.
