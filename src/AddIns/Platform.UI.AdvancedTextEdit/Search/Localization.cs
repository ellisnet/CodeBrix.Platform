...
//was previously: ICSharpCode.AvalonEdit/Search/Localization.cs in the AvalonEdit repo (MIT).

/// <summary>
/// Holds default texts for buttons and labels in the search panel. Override properties to add other languages.
/// </summary>
