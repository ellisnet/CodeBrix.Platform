...
//was previously: ICSharpCode.AvalonEdit/Highlighting/RichTextModel.cs in the AvalonEdit repo (MIT).
//FontWeight/FontStyle are now the Windows.UI.Text types. CreateRuns() was dropped: it produced WPF
//System.Windows.Documents.Run objects, which have no equivalent in this framework; use
//GetHighlightedSections() to consume the formatting instead.
