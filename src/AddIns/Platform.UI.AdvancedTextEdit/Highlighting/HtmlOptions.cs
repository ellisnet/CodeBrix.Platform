...
//was previously: ICSharpCode.AvalonEdit/Highlighting/HtmlOptions.cs in the AvalonEdit repo (MIT).
//The options-copying constructor now takes AdvancedTextEditOptions (the port's rename of the
//upstream TextEditorOptions).
...
public class HtmlOptions
{
	...
	/// <summary>
	/// Creates a new HtmlOptions instance that copies applicable options from the <see cref="AdvancedTextEditOptions"/>.
	/// </summary>
	public HtmlOptions(AdvancedTextEditOptions options) : this()
	{
		if (options == null)
		{
