...
//was previously: ICSharpCode.AvalonEdit/Highlighting/IHighlighter.cs in the AvalonEdit repo (MIT).
...
public interface IHighlighter : IDisposable
{
	...
	/// (e.g. a semantic highlighter can re-use its resolver within a highlighting group).
	/// </summary>
	/// <remarks>
