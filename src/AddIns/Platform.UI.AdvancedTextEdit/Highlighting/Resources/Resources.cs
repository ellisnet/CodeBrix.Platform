...
//was previously: ICSharpCode.AvalonEdit/Highlighting/Resources/Resources.cs in the AvalonEdit repo (MIT).
//The resource prefix (typeof(Resources).FullName + ".") now resolves to
//"CodeBrix.Platform.UI.AdvancedTextEdit.Highlighting.Resources." - the embedded resource names
//produced for the files under Highlighting/Resources by this project's RootNamespace.
