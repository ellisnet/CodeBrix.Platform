...
//was previously: ICSharpCode.AvalonEdit/Highlighting/RichTextModelWriter.cs in the AvalonEdit repo (MIT).
//Color/FontWeight/FontStyle/FontFamily in the BeginSpan overloads are now the Windows.UI /
//Windows.UI.Text / Microsoft.UI.Xaml.Media types.
