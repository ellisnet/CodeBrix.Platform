...
//was previously: ICSharpCode.AvalonEdit/Utils/IFreezable.cs in the AvalonEdit repo (MIT).
//This is the editor's own lightweight freezable contract, unrelated to any XAML-framework
//Freezable type; it ports as-is.
