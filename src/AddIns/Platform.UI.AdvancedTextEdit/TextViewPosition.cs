...
//was previously: ICSharpCode.AvalonEdit/TextViewPosition.cs in the AvalonEdit repo (MIT).
...
public struct TextViewPosition : IEquatable<TextViewPosition>, IComparable<TextViewPosition>
{
	...
	/// then both the end of the first visual line and the beginning of the second visual line
	...
	/// the value <c>true</c> indicates that the position refers to the end of the previous visual line;
	/// the value <c>false</c> indicates that the position refers to the beginning of the next visual line.
	///
