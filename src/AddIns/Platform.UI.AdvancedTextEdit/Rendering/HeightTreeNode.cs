...
//was previously: ICSharpCode.AvalonEdit/Rendering/HeightTreeNode.cs in the AvalonEdit repo (MIT).
//Transliterated unchanged apart from nullable annotations. The upstream parameterless constructor
//was dropped (it was never called and would have left the readonly documentLine field null);
//data-structure invariants the type system cannot see are recorded as Debug.Assert calls, which
//also drive the compiler's null-state analysis.
