...
//was previously: ICSharpCode.AvalonEdit/Rendering/VisualYPosition.cs in the AvalonEdit repo (MIT).
...
{
	/// <summary>
	/// Returns the top of the text line.
	/// </summary>
	LineTop,
	/// <summary>
	...
	TextTop,
	/// <summary>
	/// Returns the bottom of the text line.
	/// </summary>
	LineBottom,
	/// <summary>
