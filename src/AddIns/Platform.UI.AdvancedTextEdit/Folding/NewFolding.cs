...
//was previously: ICSharpCode.AvalonEdit/Folding/NewFolding.cs in the AvalonEdit repo (MIT).
//Transliterated unchanged apart from nullable annotations (Name is genuinely optional; the
//folding element generator shows "..." when it is null or empty).
