...
//was previously: ICSharpCode.AvalonEdit/Editing/SimpleSelection.cs in the AvalonEdit repo (MIT).
...
sealed class SimpleSelection : Selection
{
	...
	public override void ReplaceSelectionWithText(string newText)
	{
		...
		{
			ISegment surroundingSegment = new SelectionSegment(startOffset, endOffset);
