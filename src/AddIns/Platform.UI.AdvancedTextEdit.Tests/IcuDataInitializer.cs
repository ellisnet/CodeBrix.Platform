...
//was previously: copied from src/AddIns/Platform.UI.TextLayout.Tests/IcuDataInitializer.cs, with
//only the namespace changed - both suites drive the shared text engine with no application head.
