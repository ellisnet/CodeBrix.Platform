...
#else
namespace CodeBrix.Platform.UI.MediaPlayer.Skia.X11; //Was previously: Uno.UI.MediaPlayer.Skia.X11
#endif
...
internal class SharedMediaPlayerExtension : IMediaPlayerExtension
{
	...
	// right after constructing the CodeBrix.Platform.MediaPlayerCore.MediaPlayer
