...
public class VideoPresenterGpuTests
{
    private readonly ITestOutputHelper output;

    /// <summary>Creates the fixture.</summary>
    /// <param name="output">Where the measurements are written.</param>
    public VideoPresenterGpuTests(ITestOutputHelper output) => this.output = output;
    ...
    [Fact]
    public void gpu_auto_takes_the_graphics_path_when_a_context_is_there()
    {
        //Arrange
        RequireGraphics();
        ...
        {
            using VideoPresenter presenter = new VideoPresenter(graphics);
    ...
    [Fact]
    public void gpu_no_fallback_is_satisfied_by_a_real_context()
    {
        //Arrange
        RequireGraphics();
