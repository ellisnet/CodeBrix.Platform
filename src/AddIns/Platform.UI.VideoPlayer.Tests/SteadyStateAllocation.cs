// Ported from CodeBrix.VideoPlayback.Tests (commit a3f3051, MIT, same author) on 2026-08-30;
// adapted to this add-in's internal presenter and the Platform family's SkiaSharp.

using System;

namespace CodeBrix.Platform.UI.VideoPlayer.Tests; //was previously: CodeBrix.VideoPlayback.Tests;
