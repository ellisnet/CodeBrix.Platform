...
internal static class IndentedStringBuilderExtensions
{
    ...
    // Pristine Uno.Core.Extensions 4.1.1 names (used by Uno.UWPSyncGenerator); uno-6.5 renamed
    // AppendLineInvariant -> AppendLineInvariantIndented. Kept as additive aliases so both resolve.
    public static void AppendLineInvariant(this IIndentedStringBuilder builder, string pattern, params object[] replacements)
        => builder.AppendLineInvariantIndented(pattern, replacements);
