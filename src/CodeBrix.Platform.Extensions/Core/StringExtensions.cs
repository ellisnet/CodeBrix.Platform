...
internal static partial class StringExtensions
{
    ...
    // Pristine Uno.Core.Extensions 4.1.1 helpers used by Uno.UWPSyncGenerator.
    public static string TrimStart(this string source, string trimText, StringComparison comparison)
    {
        if (!string.IsNullOrEmpty(trimText) && source.StartsWith(trimText, comparison))
        {
            return source.Substring(trimText.Length);
        }
    ...
    public static bool HasValue(this string instance) => !string.IsNullOrEmpty(instance);
