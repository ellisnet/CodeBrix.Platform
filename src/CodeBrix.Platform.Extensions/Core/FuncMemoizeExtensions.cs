...
#if IS_CODEBRIX_FOUNDATION_RUNTIME_WEBASSEMBLY_PROJECT
namespace CodeBrix.Platform.Foundation.Runtime.WebAssembly.Helpers //Was previously: Uno.Foundation.Runtime.WebAssembly.Helpers
#else
